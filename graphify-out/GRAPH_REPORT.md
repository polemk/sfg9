...
## Corpus Check
- 1723 files · ~3,006,003 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15963 nodes · 20848 edges · 2173 communities (1761 shown, 412 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 228 edges (avg confidence: 0.77)
...
- Backend Specs / lib/sfg - storage_gate_spec.rb
...
- Database & Seeds / seeds/demo - Reset
...
- Frontend Components - RootRedirect.tsx
...
- Backend Models - StructuredOperation
...
- Frontend Components / ui - FormActionBar.test.tsx
- openspec/changes/s2-console-navegacao
- openspec/changes/s3-cadastros-globais
- PRODUCT.md - Product
- Frontend Features / dashboard - SummaryCards.tsx
...
- Frontend Components / charts - number.ts
...
- Backend Services / authorization - Matrix
- openspec/changes/s6-recebiveis-bordero
- Frontend Components / ui - Tooltip.tsx
- backend/app/lib/sfg - Renegotiations (2)
- API Controllers / api - Attachments
- Backend Specs / requests/api - describe
- backend/app/lib/sfg - AuditTrail
- Backend Models / concerns - Attachable
...
- Database & Seeds / migrate - IndicatorsScopeExplicito
...
- API Controllers / api - risk_movement.rb
...
- Frontend Pages / pages - availability.test.tsx
...
- Frontend Components / __tests__ - rotaAdmin.test.tsx
...
- Backend Models - risk_catalogs_spec.rb
...
- Database & Seeds / migrate - TiposDeMovimentacaoDeRisco
- Database & Seeds / migrate (11)
- Database & Seeds / migrate - OperacoesDeRisco
...
- Database & Seeds / migrate - CreateAvailabilityEntries
- Database & Seeds / migrate (13)
- Database & Seeds / migrate - CreateRenegotiations
- Database & Seeds / migrate (14)
- Database & Seeds / migrate - CreateRenegotiationPayments
- Database & Seeds / migrate (15)
- Database & Seeds / migrate - LimiteLegadoNasceSemTipo
...
- API Controllers / api - Chat
- Backend Services / auth - TokenService
...
- API Controllers / api - SegmentService
...
- Backend Services / seeds - Report
- Database & Seeds / migrate - CreatePermissions
- Database & Seeds / migrate - CreateChatSessions
...
- Database & Seeds / migrate - CreateProjects
- Database & Seeds / migrate - CreateMemberships
...
- Database & Seeds / migrate - EnableUnaccentExtension
- Database & Seeds / migrate - CreateContracts
- Database & Seeds / migrate - CreateContractDeals
...
- API Controllers / api - start
- API Controllers / api - admin_message.rb
- API Controllers / api - SessionsService
...
- Backend Services / auth - ExistingUserSessionService
...
- Database & Seeds / migrate - BackfillUserIdentifiers
...
- perguntas-rodada-1-fatias.md - perguntas-rodada-1-fatias.md
...
- Frontend Components - LoginCarousel.tsx
- migration-map.md
...
- Database & Seeds / migrate - CreateUserTypes
...
- Database & Seeds / migrate - CreateActiveStorageTables
...
- Database & Seeds / migrate - SetDefaultCustomVariables
...
- Frontend Features / chat-builder - nodes.ts
...
1. `notify` - 130 edges
2. `Requirements` - 126 edges
3. `Requirements` - 122 edges
4. `Requirements` - 114 edges
5. `Requirements` - 111 edges
6. `Requirements` - 109 edges
7. `User` - 107 edges
8. `Requirements` - 107 edges
9. `Requirements` - 99 edges
10. `Requirements` - 99 edges
...
## Communities (2173 total, 412 thin omitted)

### Community 528 - "frontend - vite.config.ts"
Cohesion: 0.33
Nodes (4): BACKEND_WS, CspOptions, toOrigin(), buildCsp()

### Community 353 - "parity-ledger.md - Parity ledger — sfg -> ai9"
Cohesion: 0.17
...
### Community 675 - "parity-ledger.md (3)"
Cohesion: 0.40
...
### Community 541 - "parity-ledger.md"
Cohesion: 0.29
...
### Community 676 - "parity-ledger.md (4)"
Cohesion: 0.40
...
### Community 542 - "parity-ledger.md (2)"
Cohesion: 0.29
...
### Community 1236 - "parity-ledger.md (7)"
Cohesion: 0.67
...
### Community 819 - "parity-ledger.md (5)"
Cohesion: 0.50
...
### Community 818 - "parity-ledger.md (6)"
Cohesion: 0.50
...
### Community 1237 - "parity-ledger.md (8)"
Cohesion: 0.67
...
### Community 55 - "Frontend Pages / pages - ProfilePage.tsx"
Cohesion: 0.08
Nodes (31): CustomText, ParagraphElement, H1Element, H2Element, BulletedListElement, ListItemElement, LinkElement, CodeBlockElement (+23 more)

### Community 10 - "Client Pages & Auth Routing"
Cohesion: 0.06
Nodes (47): UsersPage(), UserDetailPage(), SELO_POR_PAPEL, selo(), ImpersonateSearchProps, ImpersonateSearch(), ImpersonateSelectorProps, ImpersonateSelector() (+39 more)

### Community 43 - "Blog Posts & WhatsApp Admin"
Cohesion: 0.06
...
### Community 0 - "Dashboard KPIs & Flow Builder"
Cohesion: 0.03
Nodes (58): ContractVersionFormPage(), CredentialsPage(), CnpjLookup, ProvidersPage(), TIPOS_ACEITOS, ScopedLogoApi, ScopedLogoField(), ContractPage() (+50 more)

### Community 4 - "Frontend Features - formatMoney"
Cohesion: 0.07
Nodes (74): ContractDetailPage(), ProjectAvailabilitiesPage(), CarrierConnectionsPage(), ProjectsPage(), RenegotiationsPage(), InstallmentsTab(), IndicatorsPage(), ProjectIndicatorsPage() (+66 more)

### Community 112 - "Frontend Components / help - HelpCenterPage.tsx"
Cohesion: 0.09
Nodes (16): HelpCenterPage(), HelpItemEditor(), TONS, tree, updateGroup, createGroup, items, montar() (+8 more)

### Community 34 - "Frontend Pages / pages - availability.ts"
Cohesion: 0.06
Nodes (23): AvailabilityPage(), toIso(), fromIso(), formatarDataLonga(), nomeDaEmpresa(), CHAVE, paraPayload(), CURRENT_PROJECT_KEY (+15 more)

### Community 8 - "Frontend Pages / pages - CatalogScreen"
Cohesion: 0.05
Nodes (53): TIPOS_ACEITOS, CarrierLogoField(), ScreenRow, CatalogTexts, CatalogApi, CatalogScreenProps, CatalogFormProps, PAPEIS_DE_ESCRITA (+45 more)

### Community 16 - "Frontend Lib / api - projects.ts"
Cohesion: 0.05
Nodes (48): ProjectDetailPage(), formatarData(), formatarDataHora(), FormState, VAZIO, ReceivableFormPage(), num(), inteiro() (+40 more)

### Community 20 - "Frontend Lib / api - renegotiations.ts"
Cohesion: 0.05
Nodes (33): RenegotiationFormPage(), formularioVazio(), doRegistro(), RenegotiationState, RenegotiationStateFilter, Renegotiation, RenegotiationPayment, RenegotiationInstallment (+25 more)

### Community 221 - "Frontend Pages / pages - RenegotiationsPage.tsx"
Cohesion: 0.13
Nodes (12): podeRemoverMotivo(), TOM_DO_ESTADO, estadoLegivel(), EstadoBadge(), colunas, ListaEstreitaProps, ListaEstreita(), list (+4 more)

### Community 393 - "Frontend Components / renegotiations - InstallmentsTab.tsx"
Cohesion: 0.22
Nodes (6): InstallmentRowProps, InstallmentRow(), InstallmentsTabProps, PARCELA, DO_MEIO, SEMPRE

### Community 72 - "Frontend Features / attachments - index.ts"
Cohesion: 0.14
Nodes (22): Props, AttachmentUploader(), Attachment, AttachmentLimit, AttachmentLimits, AttachmentLimitsResponse, SignedAttachmentUrl, useAttachmentLimits() (+14 more)

### Community 113 - "Frontend Lib / api - indicators.ts"
Cohesion: 0.10
Nodes (20): EntryCellProps, Estado, EntryCell(), DeleteIndicatorDialogProps, DeleteIndicatorDialog(), MonthlyGridProps, IndicatorScope, IndicatorConnectionRow (+12 more)

### Community 53 - "Frontend Features / structured-operations - structuredOperations.ts"
Cohesion: 0.08
Nodes (28): OperationFormValues, OperationForm(), iso(), usePreSelecao(), RemunerationDrawer(), StructuredOperationFormPage(), vazio(), numero() (+20 more)

### Community 534 - "Frontend Components / ui - DatePicker.tsx"
Cohesion: 0.38
...
Cohesion: 0.05
Nodes (42): Wallet, ReceivableKind, TaxClassifier, MovementKind, ResourceSource, resourceSourcesApi, walletsApi, receivableKindsApi (+34 more)

### Community 116 - "Backend Services / availability - project_template_service.rb"
Cohesion: 0.17
Nodes (19): Api, V1, ProjectAvailabilities, find(), Availability, ProjectTemplateService, base_scope(), tree() (+11 more)

### Community 3 - "User Model & Code Validation"
Cohesion: 0.07
Nodes (12): counts(), grant_readonly!(), conceder(), corpo(), Permission, Permissions, PermissionAuditLog, grant_readonly!() (+4 more)

### Community 73 - "Backend Services / availability - global_template_service.rb"
Cohesion: 0.12
Nodes (23): json(), Api, Entities, AvailabilityTemplate, Api, V1, AvailabilityTemplates, Availability (+15 more)

### Community 77 - "Backend Services / availability - ProjectAvailabilityTemplate"
Cohesion: 0.11
...
### Community 107 - "API Controllers / api - recalculate!"
Cohesion: 0.12
Nodes (16): Api, Entities, Renegotiation, Api, V1, Renegotiations, representar(), next_installments_for() (+8 more)

### Community 67 - "backend/app/lib/sfg - Renegotiation"
Cohesion: 0.07
Nodes (5): Sfg, Etl, Converters, RenegotiationAttachments, Renegotiation

### Community 181 - "Backend Services / renegotiations - Formulas"
Cohesion: 0.19
Nodes (3): parcela(), Renegotiations, Formulas

### Community 63 - "backend/app"
Cohesion: 0.08
Nodes (14): Api, V1, Defaults, current_user(), Api, Root, impersonated_by_claim(), Api (+6 more)

### Community 126 - "API Controllers / api - MagicLogin"
Cohesion: 0.10
Nodes (17): Api, Auth, V1, MagicLogin, Api, Auth, V1, Registration (+9 more)

### Community 118 - "Backend Services / auth - AuthMailer"
Cohesion: 0.11
Nodes (6): Auth, InviteService, ApplicationMailer, AuthMailer, Auth, EmailService

### Community 168 - ".migration-ai9/wip-auth-backup - SecurityHelpers"
Cohesion: 0.16
Nodes (6): Api, Auth, V1, SecurityHelpers, Rack, Attack

### Community 677 - ".migration-ai9/parity/phase4"
Cohesion: 0.40
...
### Community 826 - "tools/graphify - rebuild.sh"
Cohesion: 0.50
Nodes (3): rebuild.sh script, PYTHONHASHSEED, PYTHONUTF8

### Community 462 - "tools/graphify/steps - 02_prune.py"
Cohesion: 0.25
...
### Community 47 - "tools/graphify/lib - RubyFile"
Cohesion: 0.06
...
### Community 170 - "checkpoint.md - Migration checkpoint"
Cohesion: 0.10
...
### Community 666 - "checkpoint.md - ESTADO EM 27/08/2026 02:15"
Cohesion: 0.40
...
### Community 1230 - "checkpoint.md (6)"
Cohesion: 0.67
...
### Community 1229 - "checkpoint.md - Onda em curso (26/08/2026"
Cohesion: 0.67
...
### Community 1228 - "checkpoint.md (7)"
Cohesion: 0.67
...
### Community 105 - "decisions.md - decisions.md"
Cohesion: 0.08
Nodes (25): Perguntas do QA x decisoes ja tomadas, Perguntas ainda ABERTAS para o usuario (fila do Phase 2), Estado final do Phase 1 — todas as perguntas encerradas, Correcoes trazidas pela matriz de autorizacao (24/08/2026), O DEC-04 era mais pessimista do que precisava, O defeito D-36 estava com o sintoma errado, Sexta rodada — DEC-15 (24/08/2026) — respostas sobre a matriz de autorizacao, DEC-15.1 — Disponibilidades e cobrancas estao **VIVAS** (Q-A3) (+17 more)

### Community 595 - "decisions.md (9)"
Cohesion: 0.33
...
### Community 453 - "decisions.md - O que muda"
Cohesion: 0.22
...
### Community 1232 - "decisions.md (32)"
Cohesion: 0.67
...
### Community 1231 - "decisions.md (35)"
Cohesion: 0.67
...
Cohesion: 0.21
Nodes (8): DEC-121 (26/08/2026) — **nao existe "data da carga"**: a carga real depende da venda, O que isso dissolve, O que isso NAO dissolve, Consequencia pratica para o ETL, DEC-124 (26/08/2026) — o dump **e** a carga real, e o ETL roda **no servidor**, 1. Nao existe "esperar a carga". O dump E a carga., 2. O ETL roda **no servidor de producao**, nao aqui, 3. O que NAO muda

### Community 592 - "decisions.md (13)"
Cohesion: 0.33
...
### Community 246 - "backend/app/lib/sfg - Renegotiations (3)"
Cohesion: 0.12
Nodes (4): Sfg, Etl, Converters, Renegotiations

### Community 19 - "backend/app/lib/sfg"
Cohesion: 0.08
Nodes (6): Sfg, Etl, Values, OutOfDomain, Converted, sobrevive_ao_transporte?()

### Community 341 - "backend/app/lib/sfg (2)"
Cohesion: 0.21
Nodes (4): Sfg, Etl, Decisions, Entry

### Community 64 - "backend/app/lib/sfg - Report"
Cohesion: 0.12
Nodes (7): Report, executar(), run_load(), rodar(), converter_name(), introspect(), dry_run()

### Community 267 - "backend/app/lib/sfg - Reconcile"
Cohesion: 0.17
Nodes (4): Sfg, Etl, Reconcile, IdMap

### Community 149 - "backend/app/lib/sfg - convert"
Cohesion: 0.14
Nodes (5): Pipeline, Sfg, Etl, TargetBaseline, convert()

### Community 59 - "backend/app/lib/sfg - Run"
Cohesion: 0.09
Nodes (10): Sfg, Etl, Run, Blocked, Rejection, Sfg, Etl, record!() (+2 more)

### Community 139 - "backend/app/lib/sfg - base.rb"
Cohesion: 0.09
Nodes (3): Sfg, Etl, Converters

### Community 407 - "backend/app/lib/sfg - Base (2)"
Cohesion: 0.24
Nodes (3): Base, legacy_pk(), target_class()

### Community 474 - "backend/app/lib/sfg - risk_controls.rb"
Cohesion: 0.29
...
### Community 2 - "Backend Models - Company"
Cohesion: 0.03
Nodes (33): Carrier, Carrier, ReceivableEntry, Company, SafegoldStamped, safegold_stamp_source_name(), RiskControl, Api (+25 more)

### Community 242 - "backend/app/lib/sfg - AvailabilityEntries"
Cohesion: 0.13
Nodes (4): Sfg, Etl, Converters, AvailabilityEntries

### Community 624 - "backend/app/lib/sfg - report.rb"
Cohesion: 0.40
Nodes (3): Sfg, Etl, Section

### Community 311 - "backend/app/lib/sfg - Projects"
Cohesion: 0.17
Nodes (4): Sfg, Etl, Converters, Projects

### Community 78 - "backend/app/lib/sfg - ReceivableEntries"
Cohesion: 0.11
Nodes (4): Sfg, Etl, Converters, ReceivableEntries

### Community 265 - "backend/app/lib/sfg - IndicatorEntries"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, IndicatorEntries

### Community 110 - "backend/app/lib/sfg - RiskEntries"
Cohesion: 0.09
Nodes (6): Sfg, Etl, Converters, RiskEntries, RiskEntry, nova_posicao()

### Community 32 - "Backend Services / availability - AvailabilityTemplate"
Cohesion: 0.07
...
### Community 129 - "Backend Services / seeds - RiskMovementType"
Cohesion: 0.11
Nodes (5): RiskOperationScenarios, RiskMovementType, Seeds, Reference, RiskMovementTypes

### Community 165 - "backend/app/lib/sfg - Provider"
Cohesion: 0.16
Nodes (3): Provider, Sfg, Document

### Community 15 - "Backend Models - User"
Cohesion: 0.06
Nodes (25): User, Api, V1, Users, Api, Entities, User, descartar!() (+17 more)

### Community 240 - "API Controllers / api (2)"
Cohesion: 0.16
Nodes (9): Auth, OauthService, Api, Auth, V1, Oauth, fetch_oauth_user(), fetch_google_user() (+1 more)

### Community 56 - "Backend Models - UserType"
Cohesion: 0.07
Nodes (12): bearer_for(), headers_for(), user_com_papel(), resolve_user_type(), com_papel(), Demo, Writers, Users (+4 more)

### Community 109 - "Backend Services / authorization - PermissionResolver"
Cohesion: 0.13
Nodes (6): definir_default(), concedida?(), teto(), Authorization, PermissionResolver, UserTypePermission

### Community 217 - "backend/app/lib/sfg - Archive"
Cohesion: 0.15
Nodes (6): Sfg, Etl, Archive, Missing, DirectoryArchive, TarArchive

### Community 57 - "runbook-cutover.md - 3. Sequência da janela"
Cohesion: 0.06
...
### Community 44 - "demo-seed-design.md"
Cohesion: 0.05
...
### Community 426 - "API Controllers / api - CatalogService"
Cohesion: 0.25
Nodes (5): CatalogService, Api, V1, CarrierGroups, CarrierGroupService

### Community 42 - "Backend Models / concerns - GlobalCatalog"
Cohesion: 0.06
...
### Community 22 - "Backend Services / charges - charge_service.rb"
Cohesion: 0.05
Nodes (35): Charges, update(), destroy(), statement(), Api, V1, Base, Charges (+27 more)

### Community 99 - "Backend Services / structured - operation_service.rb"
Cohesion: 0.10
Nodes (15): ChargeService, ProjectScopedService, Structured, OperationService, create(), update(), company_guard(), stamp_editor() (+7 more)

### Community 193 - "API Controllers / api - company_service.rb"
Cohesion: 0.14
Nodes (11): CompanyService, index(), risk_summary(), blank_risk_summary(), Api, Entities, Company, Api (+3 more)

### Community 18 - "API Controllers / api - ProjectToCarrierConnection"
Cohesion: 0.05
Nodes (35): ProjectGuaranteeService, base_scope(), filter(), index(), available_carriers(), ProjectCarrierConnectionService, candidates(), index() (+27 more)

### Community 141 - "Backend Services - project_scoped_service.rb"
Cohesion: 0.14
Nodes (11): base_scope(), index(), show(), create(), update(), destroy(), find(), assign() (+3 more)

### Community 74 - "Backend Services / risk - RiskOperationType"
Cohesion: 0.09
Nodes (16): uuid?(), find_in(), filter(), Risk, base_scope(), index(), filter(), janela() (+8 more)

### Community 160 - "API Controllers / api"
Cohesion: 0.13
Nodes (13): RenegotiationInstallmentService, base_scope(), index(), create_batch(), update_installment(), Api, Entities, RenegotiationInstallment (+5 more)

### Community 76 - "Backend Services / renegotiations - RenegotiationInstallment"
Cohesion: 0.10
Nodes (14): destroy_installment(), RenegotiationChannel, RenegotiationInstallment, Renegotiations, BatchDestroyInstallments, call(), remover!(), filtrar_uuids() (+6 more)

### Community 370 - "API Controllers / api - resource_source_service.rb"
Cohesion: 0.22
Nodes (5): ResourceSourceService, update(), Api, V1, ResourceSources

### Community 24 - "Backend Services / risk - RiskOperations"
Cohesion: 0.07
Nodes (38): OperationService, find(), last_movement(), update(), destroy(), Api, Entities, RiskOperationExtension (+30 more)

### Community 215 - "Backend Services / structured - remuneration_service.rb"
Cohesion: 0.12
Nodes (8): Structured, RemunerationService, Api, Entities, Remuneration, Api, V1, Remunerations

### Community 429 - "API Controllers / api - wallet_service.rb"
Cohesion: 0.25
Nodes (4): WalletService, Api, V1, Wallets

### Community 82 - "Database & Seeds / seeds/demo (3)"
Cohesion: 0.10
Nodes (10): Client, Demo, Ledger, Controls, Demo, Ledger, Cast, Demo (+2 more)

### Community 166 - "Database & Seeds / seeds/demo - Ancillary"
Cohesion: 0.16
Nodes (7): Demo, Ledger, Ancillary, Renegotiation, RenegotiationInstallment, Guarantee, IndicatorEntry

### Community 291 - "Database & Seeds / seeds/demo - coverage_spec.rb"
Cohesion: 0.18
Nodes (6): Provider, coverage_for(), complete?(), Demo, Support, Br

### Community 31 - "Database & Seeds / seeds/demo"
Cohesion: 0.09
Nodes (13): Demo, Ledger, Operations, Bordero, Operation, Movement, StaticTransfer, Demo (+5 more)

### Community 152 - "Database & Seeds / seeds/demo - records.rb"
Cohesion: 0.13
Nodes (12): Demo, Ledger, Records, Company, Control, StructuredOperation, AdminMessage, MessageNote (+4 more)

### Community 120 - "Database & Seeds / seeds/demo - Availability"
Cohesion: 0.11
Nodes (9): Month, AvailabilityTemplate, AvailabilityEntry, Demo, Ledger, Availability, Demo, Ledger (+1 more)

### Community 272 - "Database & Seeds / seeds/demo - Billing"
Cohesion: 0.20
Nodes (5): Charge, ChargeReceipt, Demo, Ledger, Billing

### Community 167 - "Database & Seeds / seeds/demo - Charges"
Cohesion: 0.17
Nodes (4): Remuneration, Demo, Writers, Charges

### Community 316 - "Database & Seeds / seeds/demo - Indicators"
Cohesion: 0.21
Nodes (3): Demo, Writers, Indicators

### Community 318 - "Database & Seeds / seeds/demo - StaticTransfers"
Cohesion: 0.21
Nodes (3): Demo, Writers, StaticTransfers

### Community 13 - "Frontend Components / chat - AIChatWidget.tsx"
Cohesion: 0.05
Nodes (48): Layout(), chatFlowsApi, ChatMessage, MarkdownComponents, renderOneBlock(), RenderMessageOptions, renderMessageContent(), DEFAULT_PERSONA (+40 more)

### Community 23 - "Backend Services"
Cohesion: 0.08
Nodes (32): ApiResponseHandler, MembershipService, index(), candidates(), create(), destroy(), release_current_project!(), serialize() (+24 more)

### Community 163 - "Backend Services - polemk_instance_service.rb"
Cohesion: 0.20
...
### Community 79 - "backend/app/lib/sfg - RiskOperationSubtypes"
Cohesion: 0.08
Nodes (8): Demo, Writers, RiskOperations, Sfg, Etl, Converters, RiskOperationSubtypes, RiskOperationSubtype

### Community 310 - "backend/app/lib/sfg - ProjectGuarantees"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, ProjectGuarantees

### Community 312 - "backend/app/lib/sfg - Remunerations"
Cohesion: 0.15
...
### Community 247 - "backend/app/lib/sfg - StructuredOperations"
Cohesion: 0.12
Nodes (4): Sfg, Etl, Converters, StructuredOperations

### Community 195 - "API Controllers / api - Receivables"
Cohesion: 0.12
Nodes (10): Api, Entities, ReceivableEntry, Api, Entities, ReceivableDerived, Entry, Api (+2 more)

### Community 340 - "backend/app/lib/sfg - ReceivableTaxes"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, ReceivableTaxes

### Community 270 - "Backend Services / receivables - call"
Cohesion: 0.18
...
### Community 243 - "backend/app/lib/sfg - ContractDeals"
Cohesion: 0.14
Nodes (4): Sfg, Etl, Converters, ContractDeals

### Community 198 - "backend/app/lib/sfg - Contracts"
Cohesion: 0.14
Nodes (4): Sfg, Etl, Converters, Contracts

### Community 307 - "backend/app/lib/sfg - HelpCategories"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, HelpCategories

### Community 337 - "backend/app/lib/sfg - HelpGroups"
Cohesion: 0.17
Nodes (4): Sfg, Etl, Converters, HelpGroups

### Community 244 - "backend/app/lib/sfg - HelpItems"
Cohesion: 0.14
Nodes (4): Sfg, Etl, Converters, HelpItems

### Community 245 - "backend/app/lib/sfg - Providers"
Cohesion: 0.14
Nodes (4): Sfg, Etl, Converters, Providers

### Community 338 - "backend/app/lib/sfg - ProjectToCarrierConnections"
Cohesion: 0.17
Nodes (4): Sfg, Etl, Converters, ProjectToCarrierConnections

### Community 375 - "backend/app/lib/sfg - ProjectGuaranteeTypes"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, ProjectGuaranteeTypes

### Community 378 - "backend/app/lib/sfg - ResourceSources"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, ResourceSources

### Community 381 - "backend/app/lib/sfg - StructuredOperationTypes"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, StructuredOperationTypes

### Community 382 - "backend/app/lib/sfg - SubSegments"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, SubSegments

### Community 17 - "upstream-flags.md"
Cohesion: 0.03
...
### Community 455 - "upstream-flags.md (2)"
Cohesion: 0.22
...
### Community 600 - "upstream-flags.md - S9 — renegociações"
Cohesion: 0.33
...
### Community 821 - "upstream-flags.md (3)"
Cohesion: 0.50
...
### Community 822 - "upstream-flags.md (4)"
Cohesion: 0.50
...
### Community 823 - "upstream-flags.md (5)"
Cohesion: 0.50
...
### Community 226 - "platform-runbook.md - Runbook de plataforma — sfg9"
Cohesion: 0.12
...
### Community 269 - "backend/app/lib/sfg - WorkerHealth"
Cohesion: 0.18
Nodes (3): Sfg, WorkerHealth, Report

### Community 88 - "Database & Seeds / seeds/demo - Reset"
Cohesion: 0.11
Nodes (5): Demo, Reset, cache(), real(), CarrierGroup

### Community 801 - "Backend Specs / lib/sfg - values_precision_spec.rb"
Cohesion: 0.83
Nodes (3): cast_sql(), cast_do_banco(), cast_float_do_banco()

### Community 7 - "Backend Services - Project"
Cohesion: 0.05
Nodes (42): Project, ProjectService, index(), autocomplete(), show(), responsible_candidates(), create(), update() (+34 more)

### Community 263 - "API Controllers / api - SecurityHelpers"
Cohesion: 0.19
...
### Community 97 - ".migration-ai9/parity - Uma linha por ID"
Cohesion: 0.07
...
### Community 222 - ".migration-ai9/parity (5)"
Cohesion: 0.12
...
### Community 114 - ".migration-ai9/parity"
Cohesion: 0.08
...
### Community 61 - "Frontend Hooks - useNavItems.ts"
Cohesion: 0.11
Nodes (27): RoleSlug, NavGroup, CONSOLE_NAV_ITEMS, ConsoleTopbar(), SidebarSearch(), menuDe(), itensDe(), menuRenderizadoDe() (+19 more)

### Community 155 - "App Shell & Route Table"
Cohesion: 0.12
Nodes (14): NavItem, CONSOLE_NAV_GROUPS, HOME_AREA, itemDePermissoes(), LoginPage, OAuthCallbackPage, MagicLinkCallbackPage, ContractPage (+6 more)

### Community 639 - "Frontend Components - RootRedirect.tsx"
Cohesion: 0.80
Nodes (4): MOUNTED_AREAS, destinoPorPapel(), RootRedirect(), rotaMontada()
...
### Community 6 - "Frontend Components / ui - cn"
Cohesion: 0.03
Nodes (53): MobileMenuActionsProps, MobileMenuActions(), MasonryGridProps, useColunas(), MasonryGrid(), SectionHeadingProps, SectionHeading(), CheckboxProps (+45 more)

### Community 587 - "Frontend Features / receivables - chargeDetailPage.test.tsx"
Cohesion: 0.33
Nodes (4): get, statement, COBRANCA, EXTRATO

### Community 804 - "Frontend Hooks - useDragToScroll.ts"
Cohesion: 0.50
Nodes (3): UseDragToScrollOptions, DragToScroll, useDragToScroll()

### Community 251 - "Frontend Components / ui - AuditEventDialog.tsx"
Cohesion: 0.18
...
### Community 121 - "Frontend Components / audit - auditTrail.ts"
Cohesion: 0.13
...
### Community 530 - "Frontend Pages / pages - auditTrailPage.test.tsx"
Cohesion: 0.29
Nodes (4): list, get, types, VERSAO

### Community 531 - "Frontend Pages / pages - RenegotiationDetailPage"
Cohesion: 0.38
Nodes (5): ABAS, Aba, RenegotiationDetailPage(), usePermission(), useIsReadonly()

### Community 641 - "Frontend Components / renegotiations - AttachmentGallery"
Cohesion: 0.50
Nodes (3): AttachmentGalleryProps, AttachmentGallery(), formatarTamanho()

### Community 411 - "Frontend Components / ui - Table.tsx"
Cohesion: 0.20
Nodes (9): TableProps, Table, TableHeader, TableBody, TableFooter, TableRow, TableHead, TableCell (+1 more)

### Community 648 - "frontend/src/__tests__ - empilhamento-barras.test.ts"
Cohesion: 0.50
Nodes (3): Z, fonte(), codigo()

### Community 140 - "backend/app/lib/sfg - LedgerGate"
Cohesion: 0.11
Nodes (4): Sfg, Etl, LedgerGate, Row

### Community 241 - "Background Jobs (2)"
Cohesion: 0.18
...
### Community 52 - "Backend Models - Receipt"
Cohesion: 0.07
Nodes (8): temp_ids_de(), receipt_id(), create_receipt(), Remuneration, headers_a(), criar_recibo(), Charge, Receipt

### Community 264 - "Backend Models - StructuredOperation"
Cohesion: 0.13
Nodes (5): headers_a(), Api, Entities, StructuredOperation, StructuredOperation

### Community 33 - "Backend Services / risk - aggregate_service.rb"
Cohesion: 0.12
Nodes (35): Risk, active_controls(), active_controls_for_rows(), base_controls(), limite_utilizado_on(), limite_total_on(), limite_disponivel_on(), perc_limite_utilizado_on() (+27 more)
...
### Community 256 - "openspec/changes/s14-etl-producao - Tasks: S14 — ETL de produção"
Cohesion: 0.12
...
### Community 260 - "openspec/changes/s5-limites-risco (2)"
Cohesion: 0.12
...
### Community 281 - "openspec/changes/s7-operacoes-risco (3)"
Cohesion: 0.13
...
### Community 238 - "openspec/changes/s8-operacoes-estruturadas"
Cohesion: 0.12
...
### Community 410 - "Frontend Components / ui - FormActionBar.test.tsx"
Cohesion: 0.27
Nodes (4): FormActionBar(), Formulario(), UnsavedChangesGuard, useUnsavedChanges()

### Community 297 - "openspec/changes/s2-console-navegacao"
Cohesion: 0.14
...
### Community 232 - "openspec/changes/s3-cadastros-globais"
Cohesion: 0.12
...
### Community 398 - "PRODUCT.md - Product"
Cohesion: 0.18
Nodes (10): Product, Platform, Users, Product Purpose, Positioning, Constraints, Terminology, Evidence & assets (+2 more)

### Community 292 - "Frontend Features / dashboard - SummaryCards.tsx"
Cohesion: 0.21
Nodes (11): IconType, corpoDoValor(), KpiCard(), ICONES, AUSENCIA, valorLegivel(), CartaoLigado(), parseValue() (+3 more)

### Community 273 - "Frontend Features / dashboard - dashboard.test.tsx"
Cohesion: 0.17
Nodes (10): mesPorExtenso(), hojeIso(), JANELAS_VALIDAS, DashboardPage(), summary, volumeByCarrier, CARTAO_SEM_DADO, RESUMO_VAZIO (+2 more)

### Community 644 - "Frontend Features / dashboard - DashboardFilters.tsx"
Cohesion: 0.50
Nodes (4): DashboardFiltersProps, JANELAS, paraIso(), DashboardFilters()

### Community 326 - "openspec/changes/s15-graficos-dashboard - Decisions"
Cohesion: 0.15
...
### Community 456 - "openspec/changes/s15-graficos-dashboard (2)"
Cohesion: 0.22
...
### Community 184 - "Frontend Components / charts - number.ts"
Cohesion: 0.20
Nodes (14): CHART_TOKENS, CategoryBarChart(), fmtMoeda, fmtCompacto, formatMoneyCompact(), fmtCompactoSimples, formatAmountCompact(), ParseResult (+6 more)

### Community 95 - "Backend Services / dashboard - SummaryService"
Cohesion: 0.15
Nodes (10): Dashboard, SummaryService, Card, call(), window_for(), AggregateService, AggregateService, Api (+2 more)

### Community 345 - "Backend Services / receivables - search_service.rb"
Cohesion: 0.21
Nodes (6): Receivables, SearchService, summary_scope(), totals(), monthly_totals(), meses_entre()

### Community 387 - "Backend Services / renegotiations - aggregate_service.rb"
Cohesion: 0.35
...
### Community 132 - "Frontend Lib / api - dashboard.ts"
Cohesion: 0.13
...
### Community 252 - "Frontend Features / indicators - CarrierVolumeChart.tsx"
Cohesion: 0.22
...
### Community 90 - "legacy-defects.md"
Cohesion: 0.07
...
### Community 442 - "Database & Seeds / seeds/demo - Remunerations"
Cohesion: 0.25
Nodes (3): Demo, Writers, Remunerations

### Community 489 - "Database & Seeds / seeds/demo - StructuredOperations"
Cohesion: 0.29
Nodes (3): Demo, Writers, StructuredOperations

### Community 361 - "openspec/changes/s20-seed-demonstracao (2)"
Cohesion: 0.17
...
### Community 599 - ".migration-ai9/tools"
Cohesion: 0.33
...
### Community 395 - ".migration-ai9/tools - browser.js"
Cohesion: 0.20
...
### Community 373 - "backend/app/lib/sfg - Companies"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, Companies

### Community 477 - "Backend Services / risk - static_pair_service.rb"
Cohesion: 0.29
Nodes (5): Risk, StaticPairService, IncompleteSubtypes, call!(), build_static()

### Community 147 - "Backend Services / authorization - Matrix"
Cohesion: 0.18
Nodes (5): Authorization, Matrix, UnknownResource, Authorization, Hierarchy
...
### Community 188 - "analise-dump-producao.md"
Cohesion: 0.11
...
### Community 70 - "backend/app/lib/sfg - Renegotiations"
Cohesion: 0.13
Nodes (5): Sfg, Etl, Parity, Renegotiations, Divergence

### Community 37 - "backend/app/lib/sfg - SqlDump"
Cohesion: 0.10
Nodes (7): fonte(), cenario(), Sfg, Etl, Source, SqlDump, SortedRows

### Community 302 - "API Controllers / api (3)"
Cohesion: 0.15
Nodes (8): Api, Entities, Indicator, Api, Entities, Project, Sfg, RichText

### Community 762 - "API Controllers / api - indicator_connection.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, IndicatorConnection

### Community 128 - "Backend Models - Indicator"
Cohesion: 0.11
Nodes (3): Indicator, PropagateIndicatorFieldsJob, PurgeDiscardedIndicatorsJob

### Community 415 - ".migration-ai9/tools - cdp.js"
Cohesion: 0.24
Nodes (7): WebSocket, fs, ws, pend, send(), evalJs(), shot()

### Community 775 - "API Controllers / api - structured_operation_type.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, StructuredOperationType

### Community 372 - "Backend Services / structured - operation_type_service.rb"
Cohesion: 0.22
Nodes (6): Api, V1, StructuredOperationTypes, Structured, OperationTypeService, update()

### Community 346 - "Backend Services / help - help_spec.rb"
Cohesion: 0.26
Nodes (3): criar_item(), Help, FieldHelp

### Community 106 - "openspec/changes/s1-autenticacao-conta"
Cohesion: 0.08
...
### Community 119 - "Auth Request Specs"
Cohesion: 0.12
Nodes (3): stop(), Auth, MagicLinkVerifyService

### Community 405 - "API Controllers / api (4)"
Cohesion: 0.24
Nodes (3): Api, V1, CatalogHelpers

### Community 439 - "Backend Services / seeds (2)"
Cohesion: 0.22
Nodes (3): Seeds, Reference, StructuredOperationTypes

### Community 646 - "Frontend Hooks - useMyPermissions.ts"
Cohesion: 0.40
Nodes (4): MyPermission, MyPermissionsResponse, MY_PERMISSIONS_KEY, useMyPermissions()

### Community 448 - "Frontend Features / chat-builder - timeAgo"
Cohesion: 0.39
...
### Community 469 - "API Controllers / api - risk_movement.rb"
Cohesion: 0.21
Nodes (6): Api, Entities, RiskMovement, Api, Entities, RiskMovementType

### Community 621 - "API Controllers / api - risk_operation.rb"
Cohesion: 0.40
Nodes (3): Api, Entities, RiskOperation

### Community 314 - "backend/app/lib/sfg - RiskMovements"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, RiskMovements

### Community 68 - "Backend Services / risk - RiskMovement"
Cohesion: 0.10
Nodes (19): RiskMovement, recalculate_chain(), movimentos_de(), persist_chain(), Risk, MovementService, create(), update() (+11 more)

### Community 130 - "Backend Models - RiskOperation"
Cohesion: 0.11
Nodes (8): RiskOperation, Calculator, last_movement(), nova(), Receivables, call!(), release_on_static_operation!(), upsert_operation!()

### Community 286 - "Backend Services / risk - ExposureCache"
Cohesion: 0.21
Nodes (6): Risk, BalanceReader, last_balances(), balance_for(), Risk, ExposureCache

### Community 220 - "Database & Seeds / seeds/demo - Stream"
Cohesion: 0.14
Nodes (4): Demo, Support, Rng, Stream

### Community 441 - "Database & Seeds / seeds/demo - AdminMessages"
Cohesion: 0.28
Nodes (3): Demo, Writers, AdminMessages

### Community 153 - "Database & Seeds / seeds/demo - AvailabilityTemplates"
Cohesion: 0.13
Nodes (7): Demo, Writers, AvailabilityEntries, Demo, Writers, AvailabilityTemplates, normalized_title()

### Community 390 - "Database & Seeds / seeds/demo - base.rb"
Cohesion: 0.25
Nodes (7): Demo, Writers, Result, owner_slice(), writer_name(), missing_models(), table_ready?()

### Community 40 - "Database & Seeds / seeds/demo (2)"
Cohesion: 0.07
Nodes (10): Base, Demo, Writers, Providers, Demo, Writers, Renegotiations, Demo (+2 more)

### Community 526 - "Database & Seeds / seeds/demo - Observers"
Cohesion: 0.29
Nodes (3): Demo, Writers, Observers

### Community 317 - "Database & Seeds / seeds/demo - ReceivableEntries"
Cohesion: 0.22
Nodes (3): Demo, Writers, ReceivableEntries

### Community 443 - "Database & Seeds / seeds/demo - RiskMovements"
Cohesion: 0.25
...
### Community 496 - "Frontend Features / risk - riskOperations.test.tsx"
Cohesion: 0.25
Nodes (5): RAIZ, RISCO, FONTES, ARQUIVOS_S7, FONTES_S7

### Community 11 - "Frontend Features / risk - risk.ts"
Cohesion: 0.05
Nodes (45): RiskOperationSubtype, RiskOperationType, RiskMovementType, RiskControl, ExposureRow, ExposureTypeGroup, TotalLimitsRow, TotalLimits (+37 more)

### Community 294 - "removed-features.md (3)"
Cohesion: 0.14
...
### Community 60 - "removed-features.md"
Cohesion: 0.06
...
### Community 356 - "removed-features.md (4)"
Cohesion: 0.17
...
### Community 680 - "removed-features.md (8)"
Cohesion: 0.40
...
### Community 414 - "removed-features.md (5)"
Cohesion: 0.20
...
### Community 597 - "removed-features.md (6)"
Cohesion: 0.33
...
### Community 1238 - "removed-features.md (10)"
Cohesion: 0.67
...
### Community 820 - "removed-features.md (9)"
Cohesion: 0.50
...
### Community 1239 - "removed-features.md (11)"
Cohesion: 0.67
...
### Community 1240 - "removed-features.md (12)"
Cohesion: 0.67
...
### Community 227 - "removed-features.md (2)"
Cohesion: 0.12
...
### Community 598 - "removed-features.md (7)"
Cohesion: 0.33
...
### Community 159 - "Auth Services & Entities"
Cohesion: 0.11
Nodes (8): Api, Auth, V1, Me, Auth, MeService, Auth, CsrfService

### Community 765 - "API Controllers / api - movement_kind.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, MovementKind

### Community 769 - "API Controllers / api - receipt.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, Receipt

### Community 770 - "API Controllers / api - receivable_kind.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, ReceivableKind

### Community 771 - "API Controllers / api - receivable_tax.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, ReceivableTax

### Community 772 - "API Controllers / api - resource_source.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, ResourceSource

### Community 777 - "API Controllers / api - wallet.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, Wallet

### Community 406 - "API Controllers / api - movement_kind_service.rb"
Cohesion: 0.22
Nodes (4): Api, V1, MovementKinds, MovementKindService

### Community 470 - "API Controllers / api - receivable_kinds.rb"
Cohesion: 0.29
Nodes (4): Api, V1, ReceivableKinds, ReceivableKindService

### Community 570 - "API Controllers / api - uploads.rb"
Cohesion: 0.40
Nodes (3): Api, V1, Uploads

### Community 148 - "Background Jobs"
Cohesion: 0.15
Nodes (5): PropagateGlobalTemplateJob, PropagateGlobalTemplateToProjectJob, padrao(), lancar(), GlobalAvailabilityTemplate

### Community 335 - "Background Jobs / receivables"
Cohesion: 0.21
Nodes (6): Receivables, BulkRecalculateJob, IofRate, effective_on(), effective_record_on(), RiskSyncService

### Community 304 - "backend/app/lib/sfg - dkim_signer.rb"
Cohesion: 0.24
Nodes (10): Sfg, DkimSigner, domain(), selector(), enabled?(), private_key(), status(), sign!() (+2 more)

### Community 305 - "backend/app/lib/sfg - ActionTextRichTexts"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, ActionTextRichTexts

### Community 336 - "backend/app/lib/sfg - Charges"
Cohesion: 0.17
Nodes (4): Sfg, Etl, Converters, Charges

### Community 374 - "backend/app/lib/sfg - MovementKinds"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, MovementKinds

### Community 339 - "backend/app/lib/sfg - Receipts"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, Receipts

### Community 377 - "backend/app/lib/sfg - ReceivableKinds"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, ReceivableKinds

### Community 383 - "backend/app/lib/sfg - Wallets"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, Wallets

### Community 342 - "backend/app/lib/sfg - Introspection"
Cohesion: 0.18
Nodes (3): Sfg, Etl, Introspection

### Community 384 - "backend/app/lib/sfg - LegacySchema"
Cohesion: 0.22
Nodes (4): Sfg, Etl, LegacySchema, UnknownDsl

### Community 623 - "backend/app/lib/sfg - pipeline.rb"
Cohesion: 0.40
Nodes (3): Sfg, Etl, Missing

### Community 268 - "backend/app/lib/sfg - Scan"
Cohesion: 0.20
Nodes (3): Sfg, Etl, Scan

### Community 178 - "backend/app/lib/sfg - Base"
Cohesion: 0.13
Nodes (5): Sfg, Etl, Source, Base, UnavailableSource

### Community 219 - "backend/app/lib/sfg - Connection"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Source, Connection

### Community 101 - "Backend Services / receivables - persist"
Cohesion: 0.11
Nodes (20): Receivables, CreateService, call(), Receivables, TaxService, build(), persist!(), Receivables (+12 more)

### Community 523 - "Backend Services / receivables - help_texts.rb"
Cohesion: 0.29
Nodes (3): Receivables, HelpTexts, all()

### Community 436 - "Backend Services / seeds - iof_rates.rb"
Cohesion: 0.22
Nodes (3): Seeds, Reference, IofRates

### Community 437 - "Backend Services / seeds - movement_kinds.rb"
Cohesion: 0.22
Nodes (3): Seeds, Reference, MovementKinds

### Community 69 - "Backend Services / seeds"
Cohesion: 0.07
...
### Community 151 - "Backend Specs / lib/sfg - engine_spec.rb"
Cohesion: 0.11
Nodes (3): Legacy, RoleMap, UnknownLegacyRole

### Community 349 - "Frontend Pages / pages - faqPage.test.tsx"
Cohesion: 0.17
Nodes (8): FaqPage(), tree, items, search, CATEGORIA, paginaVazia, montar(), faqApi

### Community 582 - "Frontend Pages / pages - availability.test.tsx"
Cohesion: 0.33
Nodes (4): RAIZ, PAGINAS, TELAS, formatarValor()

### Community 202 - "Frontend Lib / api - types.ts"
Cohesion: 0.13
...
### Community 325 - "openspec/changes/s13-jobs-integracoes (2)"
Cohesion: 0.15
...
### Community 208 - "openspec/changes/s14-etl-producao - Decisions"
Cohesion: 0.11
...
### Community 239 - "openspec/changes/trim-ai9-safegold"
Cohesion: 0.12
...
### Community 1 - "Frontend Features / chat-builder - ChatBuilderPage.tsx"
Cohesion: 0.03
Nodes (56): PageHeaderProps, PageHeader(), ButtonVariant, ButtonSize, ButtonProps, variants, sizes, spinnerSize (+48 more)

### Community 392 - "Frontend Lib - sidebarModes.ts"
Cohesion: 0.29
Nodes (7): SidebarModeToggleProps, SidebarModeToggle(), MobileTopBar(), ModeEntry, TODOS, MODE_ENTRIES, modeEntryFor()

### Community 104 - "Frontend Lib / api - ApiClient"
Cohesion: 0.10
Nodes (9): InputProps, Input, ApiClient, Country, PhoneInputGroupProps, PhoneInputGroup(), downloadBasic(), downloadFull() (+1 more)

### Community 185 - "Frontend Components / ui - Autocomplete.tsx"
Cohesion: 0.15
...
### Community 450 - "ai9-conventions.md"
Cohesion: 0.22
...
### Community 807 - "ai9-conventions.md - 1. Stack e versões exatas"
Cohesion: 0.50
Nodes (4): 1. Stack e versões exatas, Backend (`backend/`), Frontend (`frontend/`), Infra

### Community 351 - "ai9-conventions.md - 3. Backend — padrões"
Cohesion: 0.17
...
### Community 663 - "ai9-conventions.md (3)"
Cohesion: 0.40
...
### Community 664 - "ai9-conventions.md (4)"
Cohesion: 0.40
...
### Community 665 - "ai9-conventions.md - 6. Qualidade e testes"
Cohesion: 0.40
Nodes (5): 6. Qualidade e testes, Backend — RSpec, Frontend — Vitest, Lint / format, CI

### Community 494 - "frontend/scripts - mobile-audit.mjs"
Cohesion: 0.36
Nodes (7): IDS, TODAS, getCode(), SONDA(), SONDA_FIM(), relatorio, rodar()

### Community 581 - "frontend/scripts - mobile-surfaces.mjs"
Cohesion: 0.47
Nodes (5): ROTAS, getCode(), MEDIR(), achados, rodar()

### Community 30 - "Frontend Components / mobile - mobileLibrary.test.tsx"
Cohesion: 0.06
Nodes (32): MobileBottomBar(), MobileCardTone, MobileCardProps, MobileCard(), MobileChartPoint, MobileChartCardProps, FORMATO_MOEDA, FORMATO_SIMPLES (+24 more)

### Community 642 - "Frontend Components / ui - Select.tsx"
Cohesion: 0.50
Nodes (4): SelectOption, SelectProps, textoDe(), Select()

### Community 309 - "backend/app/lib/sfg - Memberships"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, Memberships

### Community 400 - "ai9-feature-selection.md"
Cohesion: 0.18
...
### Community 330 - "feature-inventory.md"
Cohesion: 0.15
...
### Community 512 - "graph-crosscheck.md"
Cohesion: 0.25
...
### Community 464 - ".migration-ai9/inventory (4)"
Cohesion: 0.22
...
### Community 84 - ".migration-ai9/inventory - Data (DB"
Cohesion: 0.07
...
### Community 401 - ".migration-ai9/inventory"
Cohesion: 0.18
...
### Community 402 - ".migration-ai9/inventory (2)"
Cohesion: 0.18
...
### Community 564 - ".migration-ai9/inventory (12)"
Cohesion: 0.29
...
### Community 466 - ".migration-ai9/inventory (6)"
Cohesion: 0.22
...
### Community 85 - ".migration-ai9/map"
Cohesion: 0.07
...
### Community 606 - "project-options.md"
Cohesion: 0.33
Nodes (5): Opções do projeto — migração sfg → ai9, Marca (branding), Mobile / PWA, Site público, Ferramentas

### Community 366 - "backend/app/lib/sfg (3)"
Cohesion: 0.25
Nodes (5): Api, Entities, AvailabilityEntry, Sfg, BusinessDays

### Community 332 - "API Controllers / api - IndicatorEntries"
Cohesion: 0.20
Nodes (9): Api, Entities, IndicatorEntry, Api, Entities, IndicatorGridRow, Api, V1 (+1 more)

### Community 194 - "API Controllers / api - provider_service.rb"
Cohesion: 0.13
Nodes (9): Api, Entities, Provider, Api, V1, Providers, ProviderService, attach_logo_file() (+1 more)

### Community 27 - "Backend Services / renegotiations - criar!"
Cohesion: 0.06
Nodes (33): Api, Entities, RenegotiationAttachment, Api, V1, RenegotiationAttachments, fetch_renegotiation!(), fetch_attachment!() (+25 more)

### Community 58 - "Backend Services (2)"
Cohesion: 0.10
Nodes (24): Api, Entities, RenegotiationPayment, Api, V1, RenegotiationPayments, fetch_renegotiation!(), fetch_installment!() (+16 more)

### Community 773 - "API Controllers / api - risk_operation_subtype.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, RiskOperationSubtype

### Community 174 - "Backend Services / availability - grid_service.rb"
Cohesion: 0.19
Nodes (17): Api, V1, AvailabilityPanel, availability_panel_payload(), resolve_company(), Availability, GridService, grid() (+9 more)

### Community 161 - "Backend Services / indicators - connection_service.rb"
Cohesion: 0.18
...
### Community 371 - "Backend Services / risk - movement_type_service.rb"
Cohesion: 0.20
Nodes (5): Api, V1, RiskMovementTypes, Risk, MovementTypeService

### Community 303 - "Backend Services / risk - operation_type_service.rb"
Cohesion: 0.18
Nodes (6): Api, V1, RiskOperationTypes, Risk, OperationTypeService, create()

### Community 117 - "backend/app/lib/sfg - AvailabilityTemplates"
Cohesion: 0.12
Nodes (4): Sfg, Etl, Converters, AvailabilityTemplates

### Community 308 - "backend/app/lib/sfg - Indicators"
Cohesion: 0.17
...
### Community 199 - "backend/app/lib/sfg - RenegotiationInstallments"
Cohesion: 0.12
Nodes (4): Sfg, Etl, Converters, RenegotiationInstallments

### Community 313 - "backend/app/lib/sfg - RenegotiationPayments"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, RenegotiationPayments

### Community 379 - "backend/app/lib/sfg - RiskOperationTypes"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, RiskOperationTypes

### Community 218 - "backend/app/lib/sfg - RiskOperations"
Cohesion: 0.12
Nodes (4): Sfg, Etl, Converters, RiskOperations

### Community 96 - "Backend Services / indicators - IndicatorEntry"
Cohesion: 0.13
Nodes (17): IndicatorEntry, Indicators, EntryService, grid(), grid_indicators(), upsert(), update(), destroy() (+9 more)

### Community 478 - "Backend Models - risk_catalogs_spec.rb"
Cohesion: 0.43
Nodes (5): MissingFunctionalType, release(), transfer_out(), transfer_in(), fetch_functional!()

### Community 80 - "Backend Services / availability"
Cohesion: 0.11
Nodes (14): Availability, AlreadyLocked, around(), lock!(), unlock!(), start!(), step!(), finish!() (+6 more)

### Community 632 - "Backend Services / indicators - backfill_service.rb"
Cohesion: 0.50
Nodes (4): Indicators, BackfillService, call(), pending_changes()

### Community 438 - "Backend Services / seeds - risk_operation_types.rb"
Cohesion: 0.22
Nodes (3): Seeds, Reference, RiskOperationTypes

### Community 525 - "Database & Seeds / seeds/demo (4)"
Cohesion: 0.33
Nodes (3): Demo, Writers, Memberships

### Community 487 - "Database & Seeds / seeds/demo - RiskControls"
Cohesion: 0.29
Nodes (3): Demo, Writers, RiskControls

### Community 274 - "Frontend Components / ui - RichTextField.tsx"
Cohesion: 0.20
...
### Community 186 - "Frontend Features / indicators - periodo.ts"
Cohesion: 0.20
Nodes (15): EntryFiltersProps, EntryFilters(), MonthlyGrid(), FORMATADOR_LONGO, FORMATADOR_CURTO, capitalizar(), MESES, nomeDoMes() (+7 more)

### Community 497 - "Frontend Lib / api - useChannel"
Cohesion: 0.32
Nodes (6): RenegotiationChannelState, useRenegotiationChannel(), useCable(), useChannel(), useTokenStore, useAccessToken()

### Community 279 - "openspec/changes/s16-pwa-minimo - Tasks: S16 — PWA mínimo"
Cohesion: 0.13
...
### Community 276 - "openspec/changes/s10-indicadores (3)"
Cohesion: 0.13
...
### Community 169 - "Frontend Pages / pages - routing.test.tsx"
Cohesion: 0.16
...
### Community 394 - "Frontend Components / ui - currency.ts"
Cohesion: 0.27
Nodes (4): MoneyInputProps, MoneyInput, CurrencyConfig, minorFactor()

### Community 432 - "backend/app/lib/sfg - Checkpoint"
Cohesion: 0.22
Nodes (3): Sfg, Etl, Checkpoint

### Community 306 - "backend/app/lib/sfg - Carriers"
Cohesion: 0.15
Nodes (4): Sfg, Etl, Converters, Carriers

### Community 380 - "backend/app/lib/sfg - Segments"
Cohesion: 0.18
Nodes (4): Sfg, Etl, Converters, Segments

### Community 343 - "backend/app/lib/sfg - Fixture"
Cohesion: 0.20
Nodes (4): Sfg, Etl, Source, Fixture

### Community 537 - "frontend/src/__tests__ - marca-fonte-unica.test.ts"
Cohesion: 0.38
Nodes (5): SRC, ISENTOS, semComentarios(), ocorrencias(), varrer()

### Community 409 - "Frontend Components / brand - Logo.tsx"
Cohesion: 0.27
Nodes (7): LogoVariant, LogoTone, LOGO_SRC, LogoProps, Logo(), SEOProps, SEO()

### Community 358 - "openspec/changes/s17-temas (2)"
Cohesion: 0.17
...
### Community 418 - "openspec/changes/s16-pwa-minimo - Design: S16 — PWA mínimo"
Cohesion: 0.20
...
### Community 249 - "Backend Services - whats_app_webhook_service.rb"
Cohesion: 0.23
...
### Community 89 - "authorization-matrix.md"
Cohesion: 0.07
...
### Community 486 - "Database & Seeds / seeds/demo - Carriers"
Cohesion: 0.29
...
### Community 122 - "Frontend Lib / api - UiKitPage.tsx"
Cohesion: 0.11
Nodes (16): Linha, LINHAS, COLUNAS, OPCOES, PESSOAS, FieldHelp(), scope, montar() (+8 more)
...
### Community 584 - "Frontend Components / contracts - termsBanner.test.tsx"
Cohesion: 0.33
Nodes (4): pending, acceptAllPending, PENDENTE, montar()

### Community 277 - "openspec/changes/s12-contratos-ajuda-faq (3)"
Cohesion: 0.13
...
### Community 681 - "API Controllers / api - base.rb (2)"
Cohesion: 0.50
Nodes (4): Api, Auth, V1, Base

### Community 756 - "API Controllers / api - attachment.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, Attachment

### Community 758 - "API Controllers / api - carrier_group.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, CarrierGroup

### Community 102 - "Chat Flows & Deliveries API"
Cohesion: 0.15
Nodes (14): ChatFlow, Api, V1, ChatFlows, ChatFlow, ChatFlowsService, index(), show() (+6 more)

### Community 301 - "API Controllers / api - Contracts"
Cohesion: 0.17
Nodes (10): Api, Entities, Contract, Api, Entities, ContractDeal, Api, V1 (+2 more)

### Community 760 - "API Controllers / api - help_category.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, HelpCategory

### Community 761 - "API Controllers / api - help_group.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, HelpGroup

### Community 367 - "Backend Services / help - Search"
Cohesion: 0.22
Nodes (5): Api, Entities, HelpItem, Help, Search

### Community 828 - "API Controllers / api - permission_audit_log.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, PermissionAuditLog

### Community 768 - "API Controllers / api - project_guarantee_type.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, ProjectGuaranteeType

### Community 774 - "API Controllers / api - segment.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, Segment

### Community 776 - "API Controllers / api - sub_segment.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, SubSegment

### Community 778 - "API Controllers / api - br_states.rb"
Cohesion: 0.67
Nodes (3): Api, V1, BrStates

### Community 333 - "API Controllers / api - carrier_service.rb"
Cohesion: 0.20
Nodes (5): Api, V1, Carriers, CarrierService, remove_logo()

### Community 422 - "API Controllers / api - Chat"
Cohesion: 0.27
Nodes (7): Api, V1, Chat, Ai, FlowMatcher, match(), match_by_keyword()

### Community 146 - "Backend Services / auth - TokenService"
Cohesion: 0.14
Nodes (6): secure_auth_nodes!(), Users, OmniauthCallbacksController, Auth, TokenService, bearer_for()
...
### Community 427 - "API Controllers / api - ContractVersions"
Cohesion: 0.25
Nodes (6): Api, V1, ContractVersions, find_version!(), Contracts, PrefillService

### Community 315 - "API Controllers / api - FlowExecution"
Cohesion: 0.17
Nodes (6): Api, V1, FlowExecutions, ApplicationRecord, FlowExecution, PermissionConflict

### Community 368 - "API Controllers / api - HelpCategory"
Cohesion: 0.18
Nodes (5): Api, V1, find_category!(), find_item!(), HelpCategory

### Community 285 - "Backend Services / help - Help"
Cohesion: 0.22
Nodes (5): Help, find_group!(), HelpGroup, Help, Tree

### Community 428 - "API Controllers / api (5)"
Cohesion: 0.25
Nodes (4): Api, V1, ProjectGuaranteeTypes, ProjectGuaranteeTypeService

### Community 682 - "API Controllers / api - chat.rb"
Cohesion: 0.50
Nodes (4): Api, V1, Public, Chat

### Community 369 - "Backend Services / contracts - Contracts"
Cohesion: 0.24
Nodes (6): Api, V1, Public, Contracts, Contracts, ReturnDestinations

### Community 471 - "API Controllers / api - SegmentService"
Cohesion: 0.29
Nodes (4): Api, V1, Segments, SegmentService

### Community 472 - "API Controllers / api - sub_segments.rb"
Cohesion: 0.29
Nodes (4): Api, V1, SubSegments, SubSegmentService

### Community 556 - "API Controllers / api - base.rb"
Cohesion: 0.33
Nodes (5): Api, Whats, V1, Base, process_service_response()

### Community 334 - "backend/app/mailers - EmailDeliveryLogger"
Cohesion: 0.21
Nodes (3): LoggedMailDeliveryJob, EmailDeliveryLogger, EmailLog

### Community 423 - "Backend Services / ai - conversation_memory.rb"
Cohesion: 0.27
Nodes (7): AgentRun, Ai, ConversationMemory, history_for(), append(), clear(), key_for()

### Community 179 - "Backend Services / contracts - Contract"
Cohesion: 0.13
Nodes (4): Contract, Contracts, Resolver, publicar()

### Community 200 - "Backend Services / contracts - ContractDeal"
Cohesion: 0.15
Nodes (5): ContractDeal, Contracts, PendingService, Contracts, ProofExport

### Community 213 - "Backend Services / ai"
Cohesion: 0.14
Nodes (5): Ai, FlowEngine, Ai, Nodes, BaseNode

### Community 557 - "Backend Services / ai - Input"
Cohesion: 0.29
Nodes (3): Ai, Nodes, Input

### Community 365 - "Backend Services / ai - AnthropicProvider"
Cohesion: 0.29
Nodes (3): Ai, Providers, AnthropicProvider

### Community 424 - "Backend Services / ai - GoogleProvider"
Cohesion: 0.33
...
### Community 558 - "Backend Services / ai - telemetry.rb"
Cohesion: 0.48
Nodes (6): Ai, Telemetry, record(), log(), summary_for(), format_value()

### Community 683 - "Backend Services / ai - tool_executor.rb"
Cohesion: 0.40
Nodes (3): Ai, Tools, ToolExecutor

### Community 603 - "Backend Services / ai - tool_registry.rb"
Cohesion: 0.40
Nodes (3): Ai, Tools, ToolRegistry

### Community 522 - "Backend Services / contracts (2)"
Cohesion: 0.52
Nodes (3): Contracts, AcceptService, Result

### Community 435 - "Backend Services / contracts - LegacyImport"
Cohesion: 0.31
Nodes (3): Contracts, LegacyImport, Report

### Community 604 - "Backend Services - evolution_connection.rb"
Cohesion: 0.33
Nodes (3): ConnectionError, TimeoutError, InvalidResponseError

### Community 481 - "Backend Services / help"
Cohesion: 0.32
Nodes (3): Help, LegacyImport, Report

### Community 408 - "Backend Services / seeds - catalog.rb"
Cohesion: 0.20
Nodes (3): Seeds, Reference, call!()

### Community 388 - "Backend Services / seeds - Contracts"
Cohesion: 0.22
...
### Community 137 - "API Controllers / api - AuthHelpers"
Cohesion: 0.12
Nodes (4): Api, Auth, V1, AuthHelpers

### Community 404 - "API Controllers / api - start"
Cohesion: 0.24
Nodes (8): Api, Auth, V1, Impersonate, Auth, ImpersonateService, start(), record_trail()

### Community 755 - "API Controllers / api - admin_message.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, AdminMessage

### Community 98 - "API Controllers / api - SessionsService"
Cohesion: 0.11
Nodes (16): Api, Entities, AuthSession, Auth, SessionsService, Api, Auth, V1 (+8 more)

### Community 764 - "API Controllers / api - message_note.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, MessageNote

### Community 766 - "API Controllers / api - observer.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, Observer

### Community 216 - "Backend Services - admin_messages_service.rb"
Cohesion: 0.27
Nodes (14): AdminMessages, AdminMessagesService, index(), show(), create(), update(), close(), destroy() (+6 more)

### Community 779 - "API Controllers / api - countries.rb"
Cohesion: 0.67
Nodes (3): Api, V1, Countries

### Community 162 - "Backend Services - Observer"
Cohesion: 0.16
Nodes (12): Api, V1, Observers, Observer, ObserversService, index(), create(), update() (+4 more)

### Community 287 - "Backend Services / ai - agent_service.rb"
Cohesion: 0.29
Nodes (13): Ai, AgentService, respond(), extract_options(), shorten_label(), tool_instructions_for(), call_simple(), call_with_tools() (+5 more)

### Community 288 - "Backend Services / ai - Redirect"
Cohesion: 0.19
Nodes (3): Ai, Nodes, Redirect

### Community 579 - "Database & Seeds / seeds/demo - Guarantees"
Cohesion: 0.33
Nodes (3): Demo, Writers, Guarantees

### Community 446 - "Frontend Features / auth - LoginPage.tsx"
Cohesion: 0.42
Nodes (5): LoginPage(), AuthStep, AuthFlow(), LoginNotice(), safeNextPath()

### Community 203 - "Frontend Lib / utils - date.ts"
Cohesion: 0.20
Nodes (14): DateLike, toDate(), formatDateLong(), nomeDoMes(), nomeDoDiaDaSemana(), dinosaurs(), mars(), dateRange() (+6 more)

### Community 359 - "openspec/changes/s19-trilha-transversais (2)"
Cohesion: 0.17
...
### Community 329 - "openspec/changes/s20-seed-demonstracao"
Cohesion: 0.15
...
### Community 459 - "openspec/changes/s20-seed-demonstracao (3)"
Cohesion: 0.22
...
### Community 173 - "openspec/changes/s20-seed-demonstracao/specs - ADDED Requirements"
Cohesion: 0.10
...
### Community 451 - "brand-and-metadata.md"
Cohesion: 0.22
...
### Community 444 - "Frontend Components / ui - react"
Cohesion: 0.22
...
### Community 324 - "openspec/changes/s0-fundacao - Tasks: S0 — Fundação"
Cohesion: 0.15
...
### Community 210 - "openspec/changes/s18-plataforma-config (2)"
Cohesion: 0.11
...
### Community 454 - "help-texts-review.md"
Cohesion: 0.22
...
### Community 355 - "perguntas-rodada-1-pos-dec30.md (3)"
Cohesion: 0.17
...
### Community 544 - "perguntas-rodada-1-pos-dec30.md (4)"
Cohesion: 0.29
...
### Community 36 - "perguntas-rodada-1-pos-dec30.md"
Cohesion: 0.05
...
### Community 191 - "perguntas-rodada-1-pos-dec30.md (2)"
Cohesion: 0.11
...
### Community 293 - "perguntas-rodada-1.md (4)"
Cohesion: 0.14
...
### Community 190 - "perguntas-rodada-1.md (3)"
Cohesion: 0.11
...
### Community 28 - "perguntas-rodada-1.md"
Cohesion: 0.04
...
### Community 224 - "perguntas-rodada-1.md - `só interno` — P-104 a P-117"
Cohesion: 0.12
...
### Community 678 - "perguntas-rodada-1.md - De-para: origem → `P-xxx`"
Cohesion: 0.40
...
### Community 679 - "perguntas-rodada-1-fatias.md - perguntas-rodada-1-fatias.md"
Cohesion: 0.40
...
### Community 354 - "perguntas-rodada-1-fatias.md - `muda número na tela`"
Cohesion: 0.17
...
### Community 223 - "perguntas-rodada-1-fatias.md - `muda escopo`"
Cohesion: 0.12
...
### Community 543 - "perguntas-rodada-1-fatias.md - `só interno`"
Cohesion: 0.29
...
### Community 321 - "perguntas-rodada-1-mapas.md (3)"
Cohesion: 0.15
...
### Community 225 - "perguntas-rodada-1-mapas.md (2)"
Cohesion: 0.12
...
### Community 41 - "perguntas-rodada-1-mapas.md"
Cohesion: 0.05
...
### Community 75 - "perguntas-rodada-1-mapas.md - `muda escopo` — Q-58 a Q-86"
Cohesion: 0.07
...
### Community 322 - "perguntas-rodada-1-mapas.md - `só interno` — Q-87 a Q-98"
Cohesion: 0.15
...
### Community 320 - "migration-map.md"
Cohesion: 0.15
...
### Community 503 - "openspec/changes/s0-fundacao - Design: S0 — Fundação"
Cohesion: 0.25
...
### Community 323 - "openspec/changes/s0-fundacao - What Changes"
Cohesion: 0.15
...
### Community 275 - "openspec/changes/s0-fundacao/specs"
Cohesion: 0.13
...
### Community 295 - "openspec/changes/s0-fundacao/specs - ADDED Requirements"
Cohesion: 0.14
...
### Community 327 - "openspec/changes/s1-autenticacao-conta (2)"
Cohesion: 0.15
...
### Community 360 - "openspec/changes/s1-autenticacao-conta - What Changes"
Cohesion: 0.17
...
### Community 328 - "openspec/changes/s1-autenticacao-conta/specs - ADDED Requirements"
Cohesion: 0.15
...
### Community 204 - "openspec/changes/s10-indicadores"
Cohesion: 0.11
...
### Community 205 - "openspec/changes/s10-indicadores (2)"
Cohesion: 0.11
...
### Community 546 - "openspec/changes/s10-indicadores/specs"
Cohesion: 0.29
...
### Community 228 - "openspec/changes/s11-disponibilidades-cobrancas (3)"
Cohesion: 0.12
...
### Community 171 - "openspec/changes/s11-disponibilidades-cobrancas (2)"
Cohesion: 0.10
...
### Community 416 - "openspec/changes/s11-disponibilidades-cobrancas/specs"
Cohesion: 0.20
...
### Community 206 - "openspec/changes/s12-contratos-ajuda-faq"
Cohesion: 0.11
...
### Community 254 - "openspec/changes/s12-contratos-ajuda-faq (2)"
Cohesion: 0.12
...
### Community 396 - "openspec/changes/s12-contratos-ajuda-faq/specs"
Cohesion: 0.18
...
### Community 547 - "openspec/changes/s12-contratos-ajuda-faq/specs (2)"
Cohesion: 0.29
...
### Community 207 - "openspec/changes/s13-jobs-integracoes - Decisions"
Cohesion: 0.11
...
### Community 601 - "openspec/changes/s13-jobs-integracoes/specs"
Cohesion: 0.33
...
### Community 602 - "openspec/changes/s13-jobs-integracoes/specs (2)"
Cohesion: 0.33
...
### Community 255 - "openspec/changes/s14-etl-producao"
Cohesion: 0.12
...
### Community 209 - "openspec/changes/s14-etl-producao/specs - ADDED Requirements"
Cohesion: 0.11
...
### Community 278 - "openspec/changes/s15-graficos-dashboard"
Cohesion: 0.13
...
### Community 417 - "openspec/changes/s15-graficos-dashboard/specs"
Cohesion: 0.20
...
### Community 504 - "openspec/changes/s15-graficos-dashboard/specs (2)"
Cohesion: 0.25
...
### Community 357 - "openspec/changes/s16-pwa-minimo"
Cohesion: 0.17
...
### Community 505 - "openspec/changes/s16-pwa-minimo/specs"
Cohesion: 0.25
...
### Community 296 - "openspec/changes/s17-temas - Design: S17 — Temas"
Cohesion: 0.14
...
### Community 229 - "openspec/changes/s17-temas"
Cohesion: 0.12
...
### Community 457 - "openspec/changes/s17-temas/specs"
Cohesion: 0.22
...
### Community 280 - "openspec/changes/s18-plataforma-config - Decisões"
Cohesion: 0.13
...
### Community 172 - "openspec/changes/s18-plataforma-config"
Cohesion: 0.10
...
### Community 419 - "openspec/changes/s18-plataforma-config/specs"
Cohesion: 0.20
...
### Community 230 - "openspec/changes/s19-trilha-transversais - Decisões"
Cohesion: 0.12
...
### Community 257 - "openspec/changes/s19-trilha-transversais"
Cohesion: 0.12
...
### Community 458 - "openspec/changes/s19-trilha-transversais/specs"
Cohesion: 0.22
...
### Community 420 - "openspec/changes/s2-console-navegacao (2)"
Cohesion: 0.20
...
### Community 397 - "openspec/changes/s2-console-navegacao - What Changes"
Cohesion: 0.18
...
### Community 362 - "openspec/changes/s2-console-navegacao/specs - ADDED Requirements"
Cohesion: 0.17
...
### Community 258 - "openspec/changes/s3-cadastros-globais - 3. Decisões por grupo de IDs"
Cohesion: 0.12
...
### Community 231 - "openspec/changes/s3-cadastros-globais (2)"
Cohesion: 0.12
...
### Community 460 - "openspec/changes/s3-cadastros-globais/specs"
Cohesion: 0.22
...
### Community 192 - "openspec/changes/s4-projeto-empresas (2)"
Cohesion: 0.11
...
### Community 211 - "openspec/changes/s4-projeto-empresas (3)"
Cohesion: 0.11
...
### Community 421 - "openspec/changes/s4-projeto-empresas/specs"
Cohesion: 0.20
...
### Community 233 - "openspec/changes/s5-limites-risco"
Cohesion: 0.12
...
### Community 259 - "openspec/changes/s5-limites-risco (3)"
Cohesion: 0.12
...
### Community 548 - "openspec/changes/s5-limites-risco/specs"
Cohesion: 0.29
...
### Community 261 - "openspec/changes/s6-recebiveis-bordero (2)"
Cohesion: 0.12
...
### Community 298 - "openspec/changes/s6-recebiveis-bordero (3)"
Cohesion: 0.14
...
### Community 299 - "openspec/changes/s6-recebiveis-bordero/specs - ADDED Requirements"
Cohesion: 0.14
...
### Community 234 - "openspec/changes/s7-operacoes-risco"
Cohesion: 0.12
...
### Community 235 - "openspec/changes/s7-operacoes-risco (2)"
Cohesion: 0.12
...
### Community 549 - "openspec/changes/s7-operacoes-risco/specs"
Cohesion: 0.29
...
### Community 236 - "openspec/changes/s8-operacoes-estruturadas (2)"
Cohesion: 0.12
...
### Community 237 - "openspec/changes/s8-operacoes-estruturadas (3)"
Cohesion: 0.12
...
### Community 550 - "openspec/changes/s8-operacoes-estruturadas/specs"
Cohesion: 0.29
...
### Community 262 - "openspec/changes/s9-renegociacoes (2)"
Cohesion: 0.12
...
### Community 282 - "openspec/changes/s9-renegociacoes (3)"
Cohesion: 0.13
...
### Community 212 - "openspec/changes/s9-renegociacoes/specs - ADDED Requirements"
Cohesion: 0.11
...
### Community 567 - "openspec/changes/trim-ai9-safegold (2)"
Cohesion: 0.29
...
### Community 684 - "openspec/changes/trim-ai9-safegold (3)"
Cohesion: 0.40
...
### Community 1247 - "openspec/specs/auth-users (20)"
Cohesion: 0.67
...
### Community 830 - "openspec/specs/auth-users (7)"
Cohesion: 0.50
...
### Community 831 - "openspec/specs/auth-users (8)"
Cohesion: 0.50
...
### Community 1248 - "openspec/specs/auth-users (21)"
Cohesion: 0.67
...
### Community 1249 - "openspec/specs/auth-users (22)"
Cohesion: 0.67
...
### Community 1250 - "openspec/specs/auth-users (23)"
Cohesion: 0.67
...
### Community 832 - "openspec/specs/auth-users (9)"
Cohesion: 0.50
...
### Community 686 - "openspec/specs/auth-users (2)"
Cohesion: 0.40
...
### Community 833 - "openspec/specs/auth-users (10)"
Cohesion: 0.50
...
### Community 1252 - "openspec/specs/auth-users (25)"
Cohesion: 0.67
...
### Community 834 - "openspec/specs/auth-users (11)"
Cohesion: 0.50
...
### Community 688 - "openspec/specs/auth-users (4)"
Cohesion: 0.40
...
### Community 1254 - "openspec/specs/auth-users (27)"
Cohesion: 0.67
...
### Community 835 - "openspec/specs/auth-users (12)"
Cohesion: 0.50
...
### Community 1255 - "openspec/specs/auth-users (28)"
Cohesion: 0.67
...
### Community 1256 - "openspec/specs/auth-users (29)"
Cohesion: 0.67
...
### Community 1257 - "openspec/specs/auth-users (30)"
Cohesion: 0.67
...
### Community 1258 - "openspec/specs/auth-users (31)"
Cohesion: 0.67
...
### Community 689 - "openspec/specs/auth-users (5)"
Cohesion: 0.40
...
### Community 1259 - "openspec/specs/auth-users (32)"
Cohesion: 0.67
...
### Community 1260 - "openspec/specs/auth-users (33)"
Cohesion: 0.67
...
### Community 690 - "openspec/specs/auth-users (6)"
Cohesion: 0.40
...
### Community 836 - "openspec/specs/auth-users (13)"
Cohesion: 0.50
...
### Community 1261 - "openspec/specs/auth-users (34)"
Cohesion: 0.67
...
### Community 1262 - "openspec/specs/auth-users (35)"
Cohesion: 0.67
...
### Community 837 - "openspec/specs/auth-users (14)"
Cohesion: 0.50
...
### Community 838 - "openspec/specs/auth-users (15)"
Cohesion: 0.50
...
### Community 1263 - "openspec/specs/auth-users (36)"
Cohesion: 0.67
...
### Community 1264 - "openspec/specs/auth-users (37)"
Cohesion: 0.67
...
### Community 839 - "openspec/specs/auth-users (16)"
Cohesion: 0.50
...
### Community 1266 - "openspec/specs/auth-users (39)"
Cohesion: 0.67
...
### Community 841 - "openspec/specs/auth-users (18)"
Cohesion: 0.50
...
### Community 1277 - "openspec/specs/auth-users (43)"
Cohesion: 0.67
...
### Community 1280 - "openspec/specs/auth-users (46)"
Cohesion: 0.67
...
### Community 1281 - "openspec/specs/auth-users (47)"
Cohesion: 0.67
...
### Community 1282 - "openspec/specs/auth-users (48)"
Cohesion: 0.67
...
### Community 1283 - "openspec/specs/auth-users (49)"
Cohesion: 0.67
...
### Community 1284 - "openspec/specs/auth-users (50)"
Cohesion: 0.67
...
### Community 1285 - "openspec/specs/auth-users (51)"
Cohesion: 0.67
...
### Community 1286 - "openspec/specs/auth-users (52)"
Cohesion: 0.67
...
### Community 1289 - "openspec/specs/auth-users (55)"
Cohesion: 0.67
...
### Community 1292 - "openspec/specs/auth-users (65)"
Cohesion: 0.67
...
### Community 1293 - "openspec/specs/auth-users (66)"
Cohesion: 0.67
...
### Community 1294 - "openspec/specs/auth-users (67)"
Cohesion: 0.67
...
### Community 1295 - "openspec/specs/auth-users (68)"
Cohesion: 0.67
...
### Community 1296 - "openspec/specs/auth-users (69)"
Cohesion: 0.67
...
### Community 21 - "openspec/specs/availability - Requirements"
Cohesion: 0.04
...
### Community 607 - "openspec/specs/availability"
Cohesion: 0.33
...
### Community 843 - "openspec/specs/availability (8)"
Cohesion: 0.50
...
### Community 844 - "openspec/specs/availability (9)"
Cohesion: 0.50
...
### Community 1298 - "openspec/specs/availability (23)"
Cohesion: 0.67
...
### Community 845 - "openspec/specs/availability (10)"
Cohesion: 0.50
...
### Community 691 - "openspec/specs/availability (2)"
Cohesion: 0.40
...
### Community 692 - "openspec/specs/availability (3)"
Cohesion: 0.40
...
### Community 846 - "openspec/specs/availability (11)"
Cohesion: 0.50
...
### Community 1299 - "openspec/specs/availability (24)"
Cohesion: 0.67
...
### Community 1300 - "openspec/specs/availability (25)"
Cohesion: 0.67
...
### Community 1301 - "openspec/specs/availability (26)"
Cohesion: 0.67
...
### Community 847 - "openspec/specs/availability (12)"
Cohesion: 0.50
...
### Community 848 - "openspec/specs/availability (13)"
Cohesion: 0.50
...
### Community 1302 - "openspec/specs/availability (27)"
Cohesion: 0.67
...
### Community 1303 - "openspec/specs/availability (28)"
Cohesion: 0.67
...
### Community 849 - "openspec/specs/availability (14)"
Cohesion: 0.50
...
### Community 850 - "openspec/specs/availability (15)"
Cohesion: 0.50
...
### Community 1304 - "openspec/specs/availability (29)"
Cohesion: 0.67
...
### Community 693 - "openspec/specs/availability (4)"
Cohesion: 0.40
...
### Community 694 - "openspec/specs/availability (5)"
Cohesion: 0.40
...
### Community 1305 - "openspec/specs/availability (30)"
Cohesion: 0.67
...
### Community 695 - "openspec/specs/availability (6)"
Cohesion: 0.40
...
### Community 851 - "openspec/specs/availability (16)"
Cohesion: 0.50
...
### Community 852 - "openspec/specs/availability (17)"
Cohesion: 0.50
...
### Community 1306 - "openspec/specs/availability (31)"
Cohesion: 0.67
...
### Community 853 - "openspec/specs/availability (18)"
Cohesion: 0.50
...
### Community 696 - "openspec/specs/availability (7)"
Cohesion: 0.40
...
### Community 1312 - "openspec/specs/availability (36)"
Cohesion: 0.67
...
### Community 854 - "openspec/specs/availability (19)"
Cohesion: 0.50
...
### Community 855 - "openspec/specs/availability (20)"
Cohesion: 0.50
...
### Community 1316 - "openspec/specs/availability (40)"
Cohesion: 0.67
...
### Community 1317 - "openspec/specs/availability (41)"
Cohesion: 0.67
...
### Community 1318 - "openspec/specs/availability (42)"
Cohesion: 0.67
...
### Community 1319 - "openspec/specs/availability (43)"
Cohesion: 0.67
...
### Community 1307 - "openspec/specs/availability (44)"
Cohesion: 0.67
...
### Community 856 - "openspec/specs/availability (21)"
Cohesion: 0.50
...
### Community 857 - "openspec/specs/availability (22)"
Cohesion: 0.50
...
### Community 1320 - "openspec/specs/availability (45)"
Cohesion: 0.67
...
### Community 1321 - "openspec/specs/availability (46)"
Cohesion: 0.67
...
### Community 1322 - "openspec/specs/availability (47)"
Cohesion: 0.67
...
### Community 38 - "openspec/specs/companies-carriers - Requirements"
Cohesion: 0.05
...
### Community 858 - "openspec/specs/companies-carriers (3)"
Cohesion: 0.50
...
### Community 859 - "openspec/specs/companies-carriers (4)"
Cohesion: 0.50
...
### Community 1324 - "openspec/specs/companies-carriers (11)"
Cohesion: 0.67
...
### Community 1325 - "openspec/specs/companies-carriers (12)"
Cohesion: 0.67
...
### Community 1326 - "openspec/specs/companies-carriers (13)"
Cohesion: 0.67
...
### Community 1327 - "openspec/specs/companies-carriers (14)"
Cohesion: 0.67
...
### Community 860 - "openspec/specs/companies-carriers (5)"
Cohesion: 0.50
...
### Community 1328 - "openspec/specs/companies-carriers (15)"
Cohesion: 0.67
...
### Community 1329 - "openspec/specs/companies-carriers (16)"
Cohesion: 0.67
...
### Community 1330 - "openspec/specs/companies-carriers (17)"
Cohesion: 0.67
...
### Community 861 - "openspec/specs/companies-carriers (6)"
Cohesion: 0.50
...
### Community 862 - "openspec/specs/companies-carriers (7)"
Cohesion: 0.50
...
### Community 1332 - "openspec/specs/companies-carriers (19)"
Cohesion: 0.67
...
### Community 1333 - "openspec/specs/companies-carriers (20)"
Cohesion: 0.67
...
### Community 1334 - "openspec/specs/companies-carriers (21)"
Cohesion: 0.67
...
### Community 1335 - "openspec/specs/companies-carriers (22)"
Cohesion: 0.67
...
### Community 1337 - "openspec/specs/companies-carriers (24)"
Cohesion: 0.67
...
### Community 1339 - "openspec/specs/companies-carriers (26)"
Cohesion: 0.67
...
### Community 1340 - "openspec/specs/companies-carriers (27)"
Cohesion: 0.67
...
### Community 864 - "openspec/specs/companies-carriers (9)"
Cohesion: 0.50
...
### Community 1341 - "openspec/specs/companies-carriers (28)"
Cohesion: 0.67
...
### Community 1342 - "openspec/specs/companies-carriers (29)"
Cohesion: 0.67
...
### Community 1343 - "openspec/specs/companies-carriers (30)"
Cohesion: 0.67
...
### Community 1344 - "openspec/specs/companies-carriers (31)"
Cohesion: 0.67
...
### Community 1345 - "openspec/specs/companies-carriers (32)"
Cohesion: 0.67
Nodes (3): Requirement: FE-070 — Linha de Fornecedor, Scenario: Fornecedor sem logo, Scenario: Clique na linha

### Community 1346 - "openspec/specs/companies-carriers (33)"
Cohesion: 0.67
...
### Community 1347 - "openspec/specs/companies-carriers (34)"
Cohesion: 0.67
...
### Community 1348 - "openspec/specs/companies-carriers (35)"
Cohesion: 0.67
...
### Community 12 - "openspec/specs/console-admin - Requirements"
Cohesion: 0.03
...
### Community 1351 - "openspec/specs/console-admin (23)"
Cohesion: 0.67
...
### Community 1352 - "openspec/specs/console-admin (24)"
Cohesion: 0.67
...
### Community 1355 - "openspec/specs/console-admin (27)"
Cohesion: 0.67
...
### Community 1356 - "openspec/specs/console-admin (28)"
Cohesion: 0.67
...
### Community 1357 - "openspec/specs/console-admin (29)"
Cohesion: 0.67
...
### Community 866 - "openspec/specs/console-admin (5)"
Cohesion: 0.50
...
### Community 867 - "openspec/specs/console-admin (6)"
Cohesion: 0.50
...
### Community 699 - "openspec/specs/console-admin"
Cohesion: 0.40
...
### Community 869 - "openspec/specs/console-admin (8)"
Cohesion: 0.50
...
### Community 870 - "openspec/specs/console-admin (9)"
Cohesion: 0.50
...
### Community 1370 - "openspec/specs/console-admin (36)"
Cohesion: 0.67
...
### Community 1371 - "openspec/specs/console-admin (37)"
Cohesion: 0.67
...
### Community 872 - "openspec/specs/console-admin (11)"
Cohesion: 0.50
...
### Community 1372 - "openspec/specs/console-admin (38)"
Cohesion: 0.67
...
### Community 1373 - "openspec/specs/console-admin (39)"
Cohesion: 0.67
...
### Community 873 - "openspec/specs/console-admin (12)"
Cohesion: 0.50
...
### Community 700 - "openspec/specs/console-admin (2)"
Cohesion: 0.40
...
### Community 874 - "openspec/specs/console-admin (13)"
Cohesion: 0.50
...
### Community 875 - "openspec/specs/console-admin (14)"
Cohesion: 0.50
...
### Community 1374 - "openspec/specs/console-admin (40)"
Cohesion: 0.67
...
### Community 876 - "openspec/specs/console-admin (15)"
Cohesion: 0.50
...
### Community 877 - "openspec/specs/console-admin (16)"
Cohesion: 0.50
...
### Community 1375 - "openspec/specs/console-admin (41)"
Cohesion: 0.67
...
### Community 1376 - "openspec/specs/console-admin (42)"
Cohesion: 0.67
...
### Community 1377 - "openspec/specs/console-admin (43)"
Cohesion: 0.67
...
### Community 878 - "openspec/specs/console-admin (17)"
Cohesion: 0.50
...
### Community 1383 - "openspec/specs/console-admin (49)"
Cohesion: 0.67
...
### Community 879 - "openspec/specs/console-admin (18)"
Cohesion: 0.50
...
### Community 1384 - "openspec/specs/console-admin (50)"
Cohesion: 0.67
...
### Community 1385 - "openspec/specs/console-admin (51)"
Cohesion: 0.67
...
### Community 880 - "openspec/specs/console-admin (19)"
Cohesion: 0.50
...
### Community 1364 - "openspec/specs/console-admin (58)"
Cohesion: 0.67
...
### Community 1365 - "openspec/specs/console-admin (59)"
Cohesion: 0.67
...
### Community 1388 - "openspec/specs/console-admin (62)"
Cohesion: 0.67
...
### Community 882 - "openspec/specs/console-admin (21)"
Cohesion: 0.50
...
### Community 701 - "openspec/specs/console-admin (3)"
Cohesion: 0.40
...
### Community 1395 - "openspec/specs/contracts (13)"
Cohesion: 0.67
...
### Community 702 - "openspec/specs/contracts"
Cohesion: 0.40
...
### Community 1396 - "openspec/specs/contracts (14)"
Cohesion: 0.67
...
### Community 883 - "openspec/specs/contracts (2)"
Cohesion: 0.50
...
### Community 884 - "openspec/specs/contracts (3)"
Cohesion: 0.50
...
### Community 885 - "openspec/specs/contracts (4)"
Cohesion: 0.50
...
### Community 886 - "openspec/specs/contracts (5)"
Cohesion: 0.50
...
### Community 1399 - "openspec/specs/contracts (17)"
Cohesion: 0.67
...
### Community 887 - "openspec/specs/contracts (6)"
Cohesion: 0.50
...
### Community 889 - "openspec/specs/contracts (7)"
Cohesion: 0.50
...
### Community 1405 - "openspec/specs/contracts (22)"
Cohesion: 0.67
...
### Community 890 - "openspec/specs/contracts (8)"
Cohesion: 0.50
...
### Community 1406 - "openspec/specs/contracts (23)"
Cohesion: 0.67
...
### Community 1407 - "openspec/specs/contracts (24)"
Cohesion: 0.67
...
### Community 891 - "openspec/specs/contracts (9)"
Cohesion: 0.50
...
### Community 1402 - "openspec/specs/contracts (25)"
Cohesion: 0.67
...
### Community 888 - "openspec/specs/contracts (10)"
Cohesion: 0.50
...
### Community 1408 - "openspec/specs/contracts (26)"
Cohesion: 0.67
...
### Community 214 - "openspec/specs/data-schema - Requirements"
Cohesion: 0.11
...
### Community 892 - "openspec/specs/data-schema (2)"
Cohesion: 0.50
...
### Community 1409 - "openspec/specs/data-schema (22)"
Cohesion: 0.67
...
### Community 1412 - "openspec/specs/data-schema (25)"
Cohesion: 0.67
...
### Community 1413 - "openspec/specs/data-schema (26)"
Cohesion: 0.67
...
### Community 1419 - "openspec/specs/data-schema (32)"
Cohesion: 0.67
...
### Community 1420 - "openspec/specs/data-schema (33)"
Cohesion: 0.67
...
### Community 1421 - "openspec/specs/data-schema (34)"
Cohesion: 0.67
...
### Community 1422 - "openspec/specs/data-schema (35)"
Cohesion: 0.67
...
### Community 896 - "openspec/specs/data-schema (6)"
Cohesion: 0.50
...
### Community 1431 - "openspec/specs/data-schema (44)"
Cohesion: 0.67
...
### Community 1432 - "openspec/specs/data-schema (45)"
Cohesion: 0.67
...
### Community 1433 - "openspec/specs/data-schema (46)"
Cohesion: 0.67
...
### Community 1437 - "openspec/specs/data-schema (50)"
Cohesion: 0.67
...
### Community 1441 - "openspec/specs/data-schema (54)"
Cohesion: 0.67
...
### Community 1445 - "openspec/specs/data-schema (58)"
Cohesion: 0.67
...
### Community 1457 - "openspec/specs/data-schema (70)"
Cohesion: 0.67
...
### Community 1461 - "openspec/specs/data-schema (74)"
Cohesion: 0.67
...
### Community 1462 - "openspec/specs/data-schema (75)"
Cohesion: 0.67
...
### Community 1463 - "openspec/specs/data-schema (76)"
Cohesion: 0.67
...
### Community 1464 - "openspec/specs/data-schema (77)"
Cohesion: 0.67
...
### Community 1465 - "openspec/specs/data-schema (78)"
Cohesion: 0.67
...
### Community 900 - "openspec/specs/data-schema (10)"
Cohesion: 0.50
...
### Community 901 - "openspec/specs/data-schema (11)"
Cohesion: 0.50
...
### Community 902 - "openspec/specs/data-schema (12)"
Cohesion: 0.50
...
### Community 703 - "openspec/specs/data-schema"
Cohesion: 0.40
...
### Community 903 - "openspec/specs/data-schema (13)"
Cohesion: 0.50
...
### Community 904 - "openspec/specs/data-schema (14)"
Cohesion: 0.50
...
### Community 905 - "openspec/specs/data-schema (15)"
Cohesion: 0.50
...
### Community 906 - "openspec/specs/data-schema (16)"
Cohesion: 0.50
...
### Community 907 - "openspec/specs/data-schema (17)"
Cohesion: 0.50
...
### Community 908 - "openspec/specs/data-schema (18)"
Cohesion: 0.50
...
### Community 909 - "openspec/specs/data-schema (19)"
Cohesion: 0.50
...
### Community 1466 - "openspec/specs/data-schema (79)"
Cohesion: 0.67
...
### Community 910 - "openspec/specs/data-schema (20)"
Cohesion: 0.50
...
### Community 1467 - "openspec/specs/data-schema (80)"
Cohesion: 0.67
...
### Community 911 - "openspec/specs/data-schema (21)"
Cohesion: 0.50
...
### Community 39 - "openspec/specs/engines - Requirements"
Cohesion: 0.05
...
### Community 1481 - "openspec/specs/engines (8)"
Cohesion: 0.67
...
### Community 1480 - "openspec/specs/engines (9)"
Cohesion: 0.67
...
### Community 608 - "openspec/specs/engines"
Cohesion: 0.33
...
### Community 1469 - "openspec/specs/engines (10)"
Cohesion: 0.67
...
### Community 1470 - "openspec/specs/engines (11)"
Cohesion: 0.67
...
### Community 704 - "openspec/specs/engines (2)"
Cohesion: 0.40
...
### Community 1473 - "openspec/specs/engines (14)"
Cohesion: 0.67
...
### Community 1474 - "openspec/specs/engines (15)"
Cohesion: 0.67
...
### Community 1475 - "openspec/specs/engines (16)"
Cohesion: 0.67
...
### Community 912 - "openspec/specs/engines (3)"
Cohesion: 0.50
...
### Community 1476 - "openspec/specs/engines (17)"
Cohesion: 0.67
...
### Community 1479 - "openspec/specs/engines (20)"
Cohesion: 0.67
...
### Community 913 - "openspec/specs/engines (4)"
Cohesion: 0.50
...
### Community 914 - "openspec/specs/engines (5)"
Cohesion: 0.50
...
### Community 1482 - "openspec/specs/engines (21)"
Cohesion: 0.67
...
### Community 1483 - "openspec/specs/engines (22)"
Cohesion: 0.67
...
### Community 1484 - "openspec/specs/engines (23)"
Cohesion: 0.67
...
### Community 1485 - "openspec/specs/engines (24)"
Cohesion: 0.67
...
### Community 1486 - "openspec/specs/engines (25)"
Cohesion: 0.67
...
### Community 915 - "openspec/specs/engines (6)"
Cohesion: 0.50
...
### Community 403 - "openspec/specs/help-faq - Requirements"
Cohesion: 0.18
...
### Community 705 - "openspec/specs/help-faq (2)"
Cohesion: 0.40
...
### Community 916 - "openspec/specs/help-faq (5)"
Cohesion: 0.50
...
### Community 917 - "openspec/specs/help-faq (6)"
Cohesion: 0.50
...
### Community 918 - "openspec/specs/help-faq (7)"
Cohesion: 0.50
...
### Community 1497 - "openspec/specs/help-faq (16)"
Cohesion: 0.67
...
### Community 609 - "openspec/specs/help-faq"
Cohesion: 0.33
...
### Community 706 - "openspec/specs/help-faq (3)"
Cohesion: 0.40
...
### Community 707 - "openspec/specs/help-faq (4)"
Cohesion: 0.40
...
### Community 1498 - "openspec/specs/help-faq (17)"
Cohesion: 0.67
...
### Community 1499 - "openspec/specs/help-faq (18)"
Cohesion: 0.67
...
### Community 919 - "openspec/specs/help-faq (8)"
Cohesion: 0.50
...
### Community 48 - "openspec/specs/indicators - Requirements"
Cohesion: 0.05
...
### Community 1506 - "openspec/specs/indicators (17)"
Cohesion: 0.67
...
### Community 1507 - "openspec/specs/indicators (18)"
Cohesion: 0.67
...
### Community 920 - "openspec/specs/indicators (2)"
Cohesion: 0.50
...
### Community 922 - "openspec/specs/indicators (4)"
Cohesion: 0.50
...
### Community 708 - "openspec/specs/indicators"
Cohesion: 0.40
...
### Community 923 - "openspec/specs/indicators (5)"
Cohesion: 0.50
...
### Community 924 - "openspec/specs/indicators (6)"
Cohesion: 0.50
...
### Community 1521 - "openspec/specs/indicators (26)"
Cohesion: 0.67
...
### Community 1522 - "openspec/specs/indicators (27)"
Cohesion: 0.67
...
### Community 1523 - "openspec/specs/indicators (28)"
Cohesion: 0.67
...
### Community 1524 - "openspec/specs/indicators (29)"
Cohesion: 0.67
...
### Community 929 - "openspec/specs/indicators (8)"
Cohesion: 0.50
...
### Community 1515 - "openspec/specs/indicators (34)"
Cohesion: 0.67
...
### Community 927 - "openspec/specs/indicators (9)"
Cohesion: 0.50
...
### Community 1510 - "openspec/specs/indicators (35)"
Cohesion: 0.67
...
### Community 1511 - "openspec/specs/indicators (36)"
Cohesion: 0.67
...
### Community 925 - "openspec/specs/indicators (10)"
Cohesion: 0.50
...
### Community 1512 - "openspec/specs/indicators (37)"
Cohesion: 0.67
...
### Community 926 - "openspec/specs/indicators (11)"
Cohesion: 0.50
...
### Community 1529 - "openspec/specs/indicators (40)"
Cohesion: 0.67
...
### Community 331 - "openspec/specs/integrations - Requirements"
Cohesion: 0.15
...
### Community 937 - "openspec/specs/integrations (3)"
Cohesion: 0.50
...
### Community 938 - "openspec/specs/integrations (4)"
Cohesion: 0.50
...
### Community 939 - "openspec/specs/integrations (5)"
Cohesion: 0.50
...
### Community 1538 - "openspec/specs/integrations (17)"
Cohesion: 0.67
...
### Community 710 - "openspec/specs/integrations - Requirement: OPS-484 — SMTP"
Cohesion: 0.40
...
### Community 940 - "openspec/specs/integrations (6)"
Cohesion: 0.50
...
### Community 941 - "openspec/specs/integrations (7)"
Cohesion: 0.50
...
### Community 711 - "openspec/specs/integrations"
Cohesion: 0.40
...
### Community 1539 - "openspec/specs/integrations (18)"
Cohesion: 0.67
...
### Community 1540 - "openspec/specs/integrations (19)"
Cohesion: 0.67
...
### Community 942 - "openspec/specs/integrations (8)"
Cohesion: 0.50
...
### Community 1541 - "openspec/specs/integrations (20)"
Cohesion: 0.67
...
### Community 1542 - "openspec/specs/integrations (21)"
Cohesion: 0.67
...
### Community 1544 - "openspec/specs/integrations (23)"
Cohesion: 0.67
...
### Community 1545 - "openspec/specs/integrations (24)"
Cohesion: 0.67
...
### Community 1546 - "openspec/specs/integrations (25)"
Cohesion: 0.67
...
### Community 1547 - "openspec/specs/integrations (26)"
Cohesion: 0.67
...
### Community 930 - "openspec/specs/integrations (10)"
Cohesion: 0.50
...
### Community 1531 - "openspec/specs/integrations (27)"
Cohesion: 0.67
...
### Community 1532 - "openspec/specs/integrations (28)"
Cohesion: 0.67
...
### Community 1533 - "openspec/specs/integrations (29)"
Cohesion: 0.67
...
### Community 931 - "openspec/specs/integrations (11)"
Cohesion: 0.50
...
### Community 1534 - "openspec/specs/integrations (30)"
Cohesion: 0.67
...
### Community 932 - "openspec/specs/integrations (12)"
Cohesion: 0.50
...
### Community 1535 - "openspec/specs/integrations (31)"
Cohesion: 0.67
...
### Community 1536 - "openspec/specs/integrations (32)"
Cohesion: 0.67
...
### Community 1537 - "openspec/specs/integrations (33)"
Cohesion: 0.67
...
### Community 709 - "openspec/specs/integrations (2)"
Cohesion: 0.40
...
### Community 936 - "openspec/specs/integrations (13)"
Cohesion: 0.50
...
### Community 933 - "openspec/specs/integrations (14)"
Cohesion: 0.50
...
### Community 934 - "openspec/specs/integrations (15)"
Cohesion: 0.50
...
### Community 935 - "openspec/specs/integrations (16)"
Cohesion: 0.50
...
### Community 568 - "openspec/specs/jobs-cron - Requirements"
Cohesion: 0.29
...
### Community 1551 - "openspec/specs/jobs-cron (11)"
Cohesion: 0.67
...
### Community 1552 - "openspec/specs/jobs-cron (12)"
Cohesion: 0.67
...
### Community 1553 - "openspec/specs/jobs-cron (13)"
Cohesion: 0.67
...
### Community 1554 - "openspec/specs/jobs-cron (14)"
Cohesion: 0.67
...
### Community 1555 - "openspec/specs/jobs-cron (15)"
Cohesion: 0.67
...
### Community 1556 - "openspec/specs/jobs-cron (16)"
Cohesion: 0.67
...
### Community 1557 - "openspec/specs/jobs-cron (17)"
Cohesion: 0.67
...
### Community 1558 - "openspec/specs/jobs-cron (18)"
Cohesion: 0.67
...
### Community 948 - "openspec/specs/jobs-cron (2)"
Cohesion: 0.50
...
### Community 1559 - "openspec/specs/jobs-cron (19)"
Cohesion: 0.67
...
### Community 949 - "openspec/specs/jobs-cron (3)"
Cohesion: 0.50
...
### Community 1560 - "openspec/specs/jobs-cron (20)"
Cohesion: 0.67
...
### Community 950 - "openspec/specs/jobs-cron (4)"
Cohesion: 0.50
...
### Community 946 - "openspec/specs/jobs-cron (5)"
Cohesion: 0.50
...
### Community 944 - "openspec/specs/jobs-cron (6)"
Cohesion: 0.50
...
### Community 945 - "openspec/specs/jobs-cron (7)"
Cohesion: 0.50
...
### Community 951 - "openspec/specs/misc-domain (2)"
Cohesion: 0.50
...
### Community 952 - "openspec/specs/misc-domain (3)"
Cohesion: 0.50
...
### Community 953 - "openspec/specs/misc-domain (4)"
Cohesion: 0.50
...
### Community 1564 - "openspec/specs/misc-domain (14)"
Cohesion: 0.67
...
### Community 954 - "openspec/specs/misc-domain (5)"
Cohesion: 0.50
...
### Community 1565 - "openspec/specs/misc-domain (15)"
Cohesion: 0.67
...
### Community 1566 - "openspec/specs/misc-domain (16)"
Cohesion: 0.67
...
### Community 956 - "openspec/specs/misc-domain (7)"
Cohesion: 0.50
...
### Community 1570 - "openspec/specs/misc-domain (20)"
Cohesion: 0.67
...
### Community 1571 - "openspec/specs/misc-domain (21)"
Cohesion: 0.67
...
### Community 1572 - "openspec/specs/misc-domain (22)"
Cohesion: 0.67
...
### Community 1573 - "openspec/specs/misc-domain (23)"
Cohesion: 0.67
...
### Community 1574 - "openspec/specs/misc-domain (24)"
Cohesion: 0.67
...
### Community 1575 - "openspec/specs/misc-domain (25)"
Cohesion: 0.67
...
### Community 1576 - "openspec/specs/misc-domain (26)"
Cohesion: 0.67
...
### Community 957 - "openspec/specs/misc-domain (8)"
Cohesion: 0.50
...
### Community 958 - "openspec/specs/misc-domain (9)"
Cohesion: 0.50
...
### Community 1577 - "openspec/specs/misc-domain (27)"
Cohesion: 0.67
...
### Community 959 - "openspec/specs/misc-domain (10)"
Cohesion: 0.50
...
### Community 712 - "openspec/specs/misc-domain"
Cohesion: 0.40
...
### Community 1592 - "openspec/specs/misc-domain (37)"
Cohesion: 0.67
...
### Community 1593 - "openspec/specs/misc-domain (38)"
Cohesion: 0.67
...
### Community 1580 - "openspec/specs/misc-domain (41)"
Cohesion: 0.67
...
### Community 1581 - "openspec/specs/misc-domain (42)"
Cohesion: 0.67
...
### Community 1582 - "openspec/specs/misc-domain (43)"
Cohesion: 0.67
...
### Community 962 - "openspec/specs/misc-domain (13)"
Cohesion: 0.50
...
### Community 425 - "openspec/specs/ops-config - Requirements"
Cohesion: 0.20
...
### Community 1595 - "openspec/specs/ops-config (9)"
Cohesion: 0.67
...
### Community 964 - "openspec/specs/ops-config (2)"
Cohesion: 0.50
...
### Community 1596 - "openspec/specs/ops-config (10)"
Cohesion: 0.67
...
### Community 1597 - "openspec/specs/ops-config (11)"
Cohesion: 0.67
...
### Community 1598 - "openspec/specs/ops-config (12)"
Cohesion: 0.67
...
### Community 1599 - "openspec/specs/ops-config (13)"
Cohesion: 0.67
...
### Community 1600 - "openspec/specs/ops-config (14)"
Cohesion: 0.67
...
### Community 1601 - "openspec/specs/ops-config (15)"
Cohesion: 0.67
...
### Community 1602 - "openspec/specs/ops-config (16)"
Cohesion: 0.67
...
### Community 1603 - "openspec/specs/ops-config (17)"
Cohesion: 0.67
...
### Community 1604 - "openspec/specs/ops-config (18)"
Cohesion: 0.67
...
### Community 965 - "openspec/specs/ops-config (3)"
Cohesion: 0.50
...
### Community 966 - "openspec/specs/ops-config (4)"
Cohesion: 0.50
...
### Community 1605 - "openspec/specs/ops-config (19)"
Cohesion: 0.67
...
### Community 967 - "openspec/specs/ops-config (5)"
Cohesion: 0.50
...
### Community 968 - "openspec/specs/ops-config (6)"
Cohesion: 0.50
...
### Community 1608 - "openspec/specs/ops-config (22)"
Cohesion: 0.67
...
### Community 1611 - "openspec/specs/ops-config (25)"
Cohesion: 0.67
...
### Community 1612 - "openspec/specs/ops-config (26)"
Cohesion: 0.67
...
### Community 1613 - "openspec/specs/ops-config (27)"
Cohesion: 0.67
...
### Community 1614 - "openspec/specs/ops-config (28)"
Cohesion: 0.67
...
### Community 1615 - "openspec/specs/ops-config (29)"
Cohesion: 0.67
...
### Community 1616 - "openspec/specs/ops-config (30)"
Cohesion: 0.67
...
### Community 1617 - "openspec/specs/ops-config (31)"
Cohesion: 0.67
...
### Community 1620 - "openspec/specs/ops-config (34)"
Cohesion: 0.67
...
### Community 1623 - "openspec/specs/ops-config (37)"
Cohesion: 0.67
...
### Community 1624 - "openspec/specs/ops-config (38)"
Cohesion: 0.67
...
### Community 1625 - "openspec/specs/ops-config (39)"
Cohesion: 0.67
...
### Community 969 - "openspec/specs/ops-config (7)"
Cohesion: 0.50
...
### Community 713 - "openspec/specs/ops-config"
Cohesion: 0.40
...
### Community 963 - "openspec/specs/ops-config (8)"
Cohesion: 0.50
...
### Community 29 - "openspec/specs/projects - Requirements"
Cohesion: 0.04
...
### Community 970 - "openspec/specs/projects (2)"
Cohesion: 0.50
...
### Community 1627 - "openspec/specs/projects (11)"
Cohesion: 0.67
...
### Community 1628 - "openspec/specs/projects (12)"
Cohesion: 0.67
...
### Community 1629 - "openspec/specs/projects (13)"
Cohesion: 0.67
...
### Community 1630 - "openspec/specs/projects (14)"
Cohesion: 0.67
...
### Community 1632 - "openspec/specs/projects (16)"
Cohesion: 0.67
...
### Community 972 - "openspec/specs/projects (4)"
Cohesion: 0.50
...
### Community 1635 - "openspec/specs/projects (19)"
Cohesion: 0.67
...
### Community 973 - "openspec/specs/projects (5)"
Cohesion: 0.50
...
### Community 1636 - "openspec/specs/projects (20)"
Cohesion: 0.67
...
### Community 1637 - "openspec/specs/projects (21)"
Cohesion: 0.67
...
### Community 714 - "openspec/specs/projects"
Cohesion: 0.40
...
### Community 1638 - "openspec/specs/projects (22)"
Cohesion: 0.67
...
### Community 974 - "openspec/specs/projects (6)"
Cohesion: 0.50
...
### Community 1639 - "openspec/specs/projects (23)"
Cohesion: 0.67
...
### Community 1640 - "openspec/specs/projects (24)"
Cohesion: 0.67
...
### Community 975 - "openspec/specs/projects (7)"
Cohesion: 0.50
...
### Community 976 - "openspec/specs/projects (8)"
Cohesion: 0.50
...
### Community 977 - "openspec/specs/projects (9)"
Cohesion: 0.50
...
### Community 1644 - "openspec/specs/projects (25)"
Cohesion: 0.67
...
### Community 1649 - "openspec/specs/projects (30)"
Cohesion: 0.67
...
### Community 1650 - "openspec/specs/projects (31)"
Cohesion: 0.67
...
### Community 1643 - "openspec/specs/projects (34)"
Cohesion: 0.67
...
### Community 1653 - "openspec/specs/projects (35)"
Cohesion: 0.67
...
### Community 1654 - "openspec/specs/projects (36)"
Cohesion: 0.67
...
### Community 978 - "openspec/specs/projects (10)"
Cohesion: 0.50
...
### Community 610 - "openspec/specs/receivables"
Cohesion: 0.33
...
### Community 979 - "openspec/specs/receivables (6)"
Cohesion: 0.50
...
### Community 980 - "openspec/specs/receivables (7)"
Cohesion: 0.50
...
### Community 1656 - "openspec/specs/receivables (29)"
Cohesion: 0.67
...
### Community 981 - "openspec/specs/receivables (8)"
Cohesion: 0.50
...
### Community 982 - "openspec/specs/receivables (9)"
Cohesion: 0.50
...
### Community 1664 - "openspec/specs/receivables (37)"
Cohesion: 0.67
...
### Community 1665 - "openspec/specs/receivables (38)"
Cohesion: 0.67
...
### Community 1666 - "openspec/specs/receivables (39)"
Cohesion: 0.67
...
### Community 1667 - "openspec/specs/receivables (40)"
Cohesion: 0.67
...
### Community 1668 - "openspec/specs/receivables (41)"
Cohesion: 0.67
...
### Community 1669 - "openspec/specs/receivables (42)"
Cohesion: 0.67
...
### Community 1670 - "openspec/specs/receivables (43)"
Cohesion: 0.67
...
### Community 1671 - "openspec/specs/receivables (44)"
Cohesion: 0.67
...
### Community 1672 - "openspec/specs/receivables (45)"
Cohesion: 0.67
...
### Community 1673 - "openspec/specs/receivables (46)"
Cohesion: 0.67
...
### Community 1674 - "openspec/specs/receivables (47)"
Cohesion: 0.67
...
### Community 1675 - "openspec/specs/receivables (48)"
Cohesion: 0.67
...
### Community 1676 - "openspec/specs/receivables (49)"
Cohesion: 0.67
...
### Community 1677 - "openspec/specs/receivables (50)"
Cohesion: 0.67
...
### Community 984 - "openspec/specs/receivables (11)"
Cohesion: 0.50
...
### Community 985 - "openspec/specs/receivables (12)"
Cohesion: 0.50
...
### Community 986 - "openspec/specs/receivables (13)"
Cohesion: 0.50
...
### Community 987 - "openspec/specs/receivables (14)"
Cohesion: 0.50
...
### Community 611 - "openspec/specs/receivables (2)"
Cohesion: 0.33
...
### Community 988 - "openspec/specs/receivables (15)"
Cohesion: 0.50
...
### Community 715 - "openspec/specs/receivables (3)"
Cohesion: 0.40
...
### Community 716 - "openspec/specs/receivables (4)"
Cohesion: 0.40
...
### Community 989 - "openspec/specs/receivables (16)"
Cohesion: 0.50
...
### Community 1691 - "openspec/specs/receivables (51)"
Cohesion: 0.67
...
### Community 1692 - "openspec/specs/receivables (52)"
Cohesion: 0.67
...
### Community 1693 - "openspec/specs/receivables (53)"
Cohesion: 0.67
...
### Community 1694 - "openspec/specs/receivables (54)"
Cohesion: 0.67
...
### Community 994 - "openspec/specs/receivables (17)"
Cohesion: 0.50
...
### Community 995 - "openspec/specs/receivables (18)"
Cohesion: 0.50
...
### Community 1697 - "openspec/specs/receivables (57)"
Cohesion: 0.67
...
### Community 996 - "openspec/specs/receivables (19)"
Cohesion: 0.50
...
### Community 1698 - "openspec/specs/receivables (58)"
Cohesion: 0.67
...
### Community 997 - "openspec/specs/receivables (20)"
Cohesion: 0.50
...
### Community 1699 - "openspec/specs/receivables (59)"
Cohesion: 0.67
...
### Community 1700 - "openspec/specs/receivables (60)"
Cohesion: 0.67
...
### Community 717 - "openspec/specs/receivables (5)"
Cohesion: 0.40
...
### Community 1701 - "openspec/specs/receivables (61)"
Cohesion: 0.67
...
### Community 1702 - "openspec/specs/receivables (62)"
Cohesion: 0.67
...
### Community 1703 - "openspec/specs/receivables (63)"
Cohesion: 0.67
...
### Community 1704 - "openspec/specs/receivables (64)"
Cohesion: 0.67
...
### Community 1707 - "openspec/specs/receivables (67)"
Cohesion: 0.67
...
### Community 998 - "openspec/specs/receivables (21)"
Cohesion: 0.50
...
### Community 999 - "openspec/specs/receivables (22)"
Cohesion: 0.50
...
### Community 1000 - "openspec/specs/receivables (23)"
Cohesion: 0.50
...
### Community 1708 - "openspec/specs/receivables (68)"
Cohesion: 0.67
...
### Community 1714 - "openspec/specs/receivables (74)"
Cohesion: 0.67
...
### Community 1715 - "openspec/specs/receivables (75)"
Cohesion: 0.67
...
### Community 1716 - "openspec/specs/receivables (76)"
Cohesion: 0.67
...
### Community 1678 - "openspec/specs/receivables (80)"
Cohesion: 0.67
...
### Community 990 - "openspec/specs/receivables (24)"
Cohesion: 0.50
...
### Community 1679 - "openspec/specs/receivables (81)"
Cohesion: 0.67
...
### Community 1680 - "openspec/specs/receivables (82)"
Cohesion: 0.67
...
### Community 1681 - "openspec/specs/receivables (83)"
Cohesion: 0.67
...
### Community 1682 - "openspec/specs/receivables (84)"
Cohesion: 0.67
...
### Community 1683 - "openspec/specs/receivables (85)"
Cohesion: 0.67
...
### Community 1684 - "openspec/specs/receivables (86)"
Cohesion: 0.67
...
### Community 991 - "openspec/specs/receivables (25)"
Cohesion: 0.50
...
### Community 992 - "openspec/specs/receivables (26)"
Cohesion: 0.50
...
### Community 993 - "openspec/specs/receivables (27)"
Cohesion: 0.50
...
### Community 1687 - "openspec/specs/receivables (89)"
Cohesion: 0.67
...
### Community 1688 - "openspec/specs/receivables (90)"
Cohesion: 0.67
...
### Community 1689 - "openspec/specs/receivables (91)"
Cohesion: 0.67
...
### Community 1690 - "openspec/specs/receivables (92)"
Cohesion: 0.67
...
### Community 1720 - "openspec/specs/receivables (93)"
Cohesion: 0.67
...
### Community 1721 - "openspec/specs/receivables (94)"
Cohesion: 0.67
...
### Community 1722 - "openspec/specs/receivables (95)"
Cohesion: 0.67
...
### Community 1723 - "openspec/specs/receivables (96)"
Cohesion: 0.67
...
### Community 1724 - "openspec/specs/receivables (97)"
Cohesion: 0.67
...
### Community 1725 - "openspec/specs/receivables (98)"
Cohesion: 0.67
...
### Community 1001 - "openspec/specs/receivables (28)"
Cohesion: 0.50
...
### Community 66 - "openspec/specs/renegotiations - Requirements"
Cohesion: 0.06
...
### Community 1002 - "openspec/specs/renegotiations (15)"
Cohesion: 0.50
...
### Community 1003 - "openspec/specs/renegotiations (16)"
Cohesion: 0.50
...
### Community 1004 - "openspec/specs/renegotiations (17)"
Cohesion: 0.50
...
### Community 1005 - "openspec/specs/renegotiations (18)"
Cohesion: 0.50
...
### Community 1729 - "openspec/specs/renegotiations (53)"
Cohesion: 0.67
...
### Community 1730 - "openspec/specs/renegotiations (54)"
Cohesion: 0.67
...
### Community 718 - "openspec/specs/renegotiations (4)"
Cohesion: 0.40
...
### Community 1006 - "openspec/specs/renegotiations (19)"
Cohesion: 0.50
...
### Community 1731 - "openspec/specs/renegotiations (55)"
Cohesion: 0.67
...
### Community 719 - "openspec/specs/renegotiations (5)"
Cohesion: 0.40
...
### Community 1732 - "openspec/specs/renegotiations (56)"
Cohesion: 0.67
...
### Community 1733 - "openspec/specs/renegotiations (57)"
Cohesion: 0.67
...
### Community 1734 - "openspec/specs/renegotiations (58)"
Cohesion: 0.67
...
### Community 1007 - "openspec/specs/renegotiations (20)"
Cohesion: 0.50
...
### Community 1008 - "openspec/specs/renegotiations (21)"
Cohesion: 0.50
...
### Community 720 - "openspec/specs/renegotiations (6)"
Cohesion: 0.40
...
### Community 721 - "openspec/specs/renegotiations (7)"
Cohesion: 0.40
...
### Community 722 - "openspec/specs/renegotiations (8)"
Cohesion: 0.40
...
### Community 723 - "openspec/specs/renegotiations (9)"
Cohesion: 0.40
...
### Community 1009 - "openspec/specs/renegotiations (22)"
Cohesion: 0.50
...
### Community 1010 - "openspec/specs/renegotiations (23)"
Cohesion: 0.50
...
### Community 1011 - "openspec/specs/renegotiations (24)"
Cohesion: 0.50
...
### Community 612 - "openspec/specs/renegotiations (2)"
Cohesion: 0.33
...
### Community 1012 - "openspec/specs/renegotiations (25)"
Cohesion: 0.50
...
### Community 1013 - "openspec/specs/renegotiations (26)"
Cohesion: 0.50
...
### Community 1014 - "openspec/specs/renegotiations (27)"
Cohesion: 0.50
...
### Community 1735 - "openspec/specs/renegotiations (59)"
Cohesion: 0.67
...
### Community 724 - "openspec/specs/renegotiations (10)"
Cohesion: 0.40
...
### Community 1015 - "openspec/specs/renegotiations (28)"
Cohesion: 0.50
...
### Community 513 - "openspec/specs/renegotiations"
Cohesion: 0.25
...
### Community 1016 - "openspec/specs/renegotiations (29)"
Cohesion: 0.50
...
### Community 725 - "openspec/specs/renegotiations (11)"
Cohesion: 0.40
...
### Community 1017 - "openspec/specs/renegotiations (30)"
Cohesion: 0.50
...
### Community 1021 - "openspec/specs/renegotiations (31)"
Cohesion: 0.50
...
### Community 1743 - "openspec/specs/renegotiations (61)"
Cohesion: 0.67
...
### Community 1022 - "openspec/specs/renegotiations (32)"
Cohesion: 0.50
...
### Community 1024 - "openspec/specs/renegotiations (34)"
Cohesion: 0.50
...
### Community 1745 - "openspec/specs/renegotiations (63)"
Cohesion: 0.67
...
### Community 1746 - "openspec/specs/renegotiations (64)"
Cohesion: 0.67
...
### Community 1025 - "openspec/specs/renegotiations (35)"
Cohesion: 0.50
...
### Community 1747 - "openspec/specs/renegotiations (65)"
Cohesion: 0.67
...
### Community 726 - "openspec/specs/renegotiations (12)"
Cohesion: 0.40
...
### Community 1026 - "openspec/specs/renegotiations (36)"
Cohesion: 0.50
...
### Community 727 - "openspec/specs/renegotiations (13)"
Cohesion: 0.40
...
### Community 1027 - "openspec/specs/renegotiations (37)"
Cohesion: 0.50
...
### Community 1028 - "openspec/specs/renegotiations (38)"
Cohesion: 0.50
...
### Community 1750 - "openspec/specs/renegotiations (68)"
Cohesion: 0.67
...
### Community 1751 - "openspec/specs/renegotiations (69)"
Cohesion: 0.67
...
### Community 1029 - "openspec/specs/renegotiations (39)"
Cohesion: 0.50
...
### Community 1752 - "openspec/specs/renegotiations (70)"
Cohesion: 0.67
...
### Community 1030 - "openspec/specs/renegotiations (40)"
Cohesion: 0.50
...
### Community 1031 - "openspec/specs/renegotiations (41)"
Cohesion: 0.50
...
### Community 1032 - "openspec/specs/renegotiations (42)"
Cohesion: 0.50
...
### Community 1753 - "openspec/specs/renegotiations (71)"
Cohesion: 0.67
...
### Community 728 - "openspec/specs/renegotiations (14)"
Cohesion: 0.40
...
### Community 1754 - "openspec/specs/renegotiations (72)"
Cohesion: 0.67
...
### Community 1755 - "openspec/specs/renegotiations (73)"
Cohesion: 0.67
...
### Community 1756 - "openspec/specs/renegotiations (74)"
Cohesion: 0.67
...
### Community 1033 - "openspec/specs/renegotiations (43)"
Cohesion: 0.50
...
### Community 1034 - "openspec/specs/renegotiations (44)"
Cohesion: 0.50
...
### Community 1757 - "openspec/specs/renegotiations (75)"
Cohesion: 0.67
...
### Community 1035 - "openspec/specs/renegotiations (45)"
Cohesion: 0.50
...
### Community 1758 - "openspec/specs/renegotiations (76)"
Cohesion: 0.67
...
### Community 1018 - "openspec/specs/renegotiations (46)"
Cohesion: 0.50
...
### Community 1019 - "openspec/specs/renegotiations (47)"
Cohesion: 0.50
...
### Community 1020 - "openspec/specs/renegotiations (48)"
Cohesion: 0.50
...
### Community 1737 - "openspec/specs/renegotiations (77)"
Cohesion: 0.67
...
### Community 1738 - "openspec/specs/renegotiations (78)"
Cohesion: 0.67
...
### Community 1739 - "openspec/specs/renegotiations (79)"
Cohesion: 0.67
...
### Community 1740 - "openspec/specs/renegotiations (80)"
Cohesion: 0.67
...
### Community 1741 - "openspec/specs/renegotiations (81)"
Cohesion: 0.67
...
### Community 1742 - "openspec/specs/renegotiations (82)"
Cohesion: 0.67
...
### Community 1036 - "openspec/specs/renegotiations (49)"
Cohesion: 0.50
...
### Community 1759 - "openspec/specs/renegotiations (83)"
Cohesion: 0.67
...
### Community 1760 - "openspec/specs/renegotiations (84)"
Cohesion: 0.67
...
### Community 1761 - "openspec/specs/renegotiations (85)"
Cohesion: 0.67
...
### Community 1762 - "openspec/specs/renegotiations (86)"
Cohesion: 0.67
...
### Community 1763 - "openspec/specs/renegotiations (87)"
Cohesion: 0.67
...
### Community 1037 - "openspec/specs/renegotiations (50)"
Cohesion: 0.50
...
### Community 45 - "openspec/specs/risk - Requirements"
Cohesion: 0.05
...
### Community 1038 - "openspec/specs/risk (18)"
Cohesion: 0.50
...
### Community 729 - "openspec/specs/risk (6)"
Cohesion: 0.40
...
### Community 1039 - "openspec/specs/risk (19)"
Cohesion: 0.50
...
### Community 1040 - "openspec/specs/risk (20)"
Cohesion: 0.50
...
### Community 1041 - "openspec/specs/risk (21)"
Cohesion: 0.50
...
### Community 1042 - "openspec/specs/risk (22)"
Cohesion: 0.50
...
### Community 1043 - "openspec/specs/risk (23)"
Cohesion: 0.50
...
### Community 1044 - "openspec/specs/risk (24)"
Cohesion: 0.50
...
### Community 1045 - "openspec/specs/risk (25)"
Cohesion: 0.50
...
### Community 1046 - "openspec/specs/risk (26)"
Cohesion: 0.50
...
### Community 1768 - "openspec/specs/risk (69)"
Cohesion: 0.67
...
### Community 1769 - "openspec/specs/risk (70)"
Cohesion: 0.67
...
### Community 731 - "openspec/specs/risk (8)"
Cohesion: 0.40
...
### Community 1047 - "openspec/specs/risk (27)"
Cohesion: 0.50
...
### Community 1771 - "openspec/specs/risk (72)"
Cohesion: 0.67
...
### Community 614 - "openspec/specs/risk (2)"
Cohesion: 0.33
...
### Community 1048 - "openspec/specs/risk (28)"
Cohesion: 0.50
...
### Community 1772 - "openspec/specs/risk (73)"
Cohesion: 0.67
...
### Community 1049 - "openspec/specs/risk (29)"
Cohesion: 0.50
...
### Community 1050 - "openspec/specs/risk (30)"
Cohesion: 0.50
...
### Community 615 - "openspec/specs/risk (3)"
Cohesion: 0.33
...
### Community 1051 - "openspec/specs/risk (31)"
Cohesion: 0.50
...
### Community 1052 - "openspec/specs/risk (32)"
Cohesion: 0.50
...
### Community 732 - "openspec/specs/risk (9)"
Cohesion: 0.40
...
### Community 1053 - "openspec/specs/risk (33)"
Cohesion: 0.50
...
### Community 733 - "openspec/specs/risk (10)"
Cohesion: 0.40
...
### Community 1773 - "openspec/specs/risk (74)"
Cohesion: 0.67
...
### Community 1054 - "openspec/specs/risk (34)"
Cohesion: 0.50
...
### Community 1055 - "openspec/specs/risk (35)"
Cohesion: 0.50
...
### Community 1056 - "openspec/specs/risk (36)"
Cohesion: 0.50
...
### Community 734 - "openspec/specs/risk (11)"
Cohesion: 0.40
...
### Community 1057 - "openspec/specs/risk (37)"
Cohesion: 0.50
...
### Community 1058 - "openspec/specs/risk (38)"
Cohesion: 0.50
...
### Community 1059 - "openspec/specs/risk (39)"
Cohesion: 0.50
...
### Community 735 - "openspec/specs/risk (12)"
Cohesion: 0.40
...
### Community 736 - "openspec/specs/risk (13)"
Cohesion: 0.40
...
### Community 616 - "openspec/specs/risk (4)"
Cohesion: 0.33
...
### Community 514 - "openspec/specs/risk"
Cohesion: 0.25
...
### Community 617 - "openspec/specs/risk (5)"
Cohesion: 0.33
...
### Community 1066 - "openspec/specs/risk (40)"
Cohesion: 0.50
...
### Community 1067 - "openspec/specs/risk (41)"
Cohesion: 0.50
...
### Community 1786 - "openspec/specs/risk (83)"
Cohesion: 0.67
...
### Community 1068 - "openspec/specs/risk (42)"
Cohesion: 0.50
...
### Community 1069 - "openspec/specs/risk (43)"
Cohesion: 0.50
...
### Community 1070 - "openspec/specs/risk (44)"
Cohesion: 0.50
...
### Community 1071 - "openspec/specs/risk (45)"
Cohesion: 0.50
...
### Community 1072 - "openspec/specs/risk (46)"
Cohesion: 0.50
...
### Community 738 - "openspec/specs/risk (15)"
Cohesion: 0.40
...
### Community 1793 - "openspec/specs/risk (90)"
Cohesion: 0.67
...
### Community 1794 - "openspec/specs/risk (91)"
Cohesion: 0.67
...
### Community 1073 - "openspec/specs/risk (47)"
Cohesion: 0.50
...
### Community 1795 - "openspec/specs/risk (92)"
Cohesion: 0.67
...
### Community 1796 - "openspec/specs/risk (93)"
Cohesion: 0.67
...
### Community 1797 - "openspec/specs/risk (94)"
Cohesion: 0.67
...
### Community 1798 - "openspec/specs/risk (95)"
Cohesion: 0.67
...
### Community 1074 - "openspec/specs/risk (48)"
Cohesion: 0.50
...
### Community 1075 - "openspec/specs/risk (49)"
Cohesion: 0.50
...
### Community 1076 - "openspec/specs/risk (50)"
Cohesion: 0.50
...
### Community 1077 - "openspec/specs/risk (51)"
Cohesion: 0.50
...
### Community 1799 - "openspec/specs/risk (96)"
Cohesion: 0.67
...
### Community 739 - "openspec/specs/risk (16)"
Cohesion: 0.40
...
### Community 1080 - "openspec/specs/risk (54)"
Cohesion: 0.50
...
### Community 1800 - "openspec/specs/risk (97)"
Cohesion: 0.67
...
### Community 1081 - "openspec/specs/risk (55)"
Cohesion: 0.50
...
### Community 1082 - "openspec/specs/risk (56)"
Cohesion: 0.50
...
### Community 740 - "openspec/specs/risk (17)"
Cohesion: 0.40
...
### Community 1083 - "openspec/specs/risk (57)"
Cohesion: 0.50
...
### Community 1084 - "openspec/specs/risk (58)"
Cohesion: 0.50
...
### Community 1060 - "openspec/specs/risk (59)"
Cohesion: 0.50
...
### Community 1774 - "openspec/specs/risk (98)"
Cohesion: 0.67
...
### Community 1775 - "openspec/specs/risk (99)"
Cohesion: 0.67
...
### Community 1061 - "openspec/specs/risk (60)"
Cohesion: 0.50
...
### Community 1062 - "openspec/specs/risk (61)"
Cohesion: 0.50
...
### Community 1063 - "openspec/specs/risk (62)"
Cohesion: 0.50
...
### Community 1064 - "openspec/specs/risk (63)"
Cohesion: 0.50
...
### Community 1776 - "openspec/specs/risk (100)"
Cohesion: 0.67
...
### Community 1065 - "openspec/specs/risk (64)"
Cohesion: 0.50
...
### Community 1777 - "openspec/specs/risk (101)"
Cohesion: 0.67
...
### Community 1803 - "openspec/specs/risk (104)"
Cohesion: 0.67
...
### Community 1804 - "openspec/specs/risk (105)"
Cohesion: 0.67
...
### Community 1805 - "openspec/specs/risk (106)"
Cohesion: 0.67
...
### Community 1806 - "openspec/specs/risk (107)"
Cohesion: 0.67
...
### Community 1085 - "openspec/specs/risk (65)"
Cohesion: 0.50
...
### Community 62 - "openspec/specs/structured-operations - Requirements"
Cohesion: 0.06
...
### Community 1086 - "openspec/specs/structured-operations (15)"
Cohesion: 0.50
...
### Community 1087 - "openspec/specs/structured-operations (16)"
Cohesion: 0.50
...
### Community 741 - "openspec/specs/structured-operations (3)"
Cohesion: 0.40
...
### Community 1088 - "openspec/specs/structured-operations (17)"
Cohesion: 0.50
...
### Community 1807 - "openspec/specs/structured-operations (54)"
Cohesion: 0.67
...
### Community 1089 - "openspec/specs/structured-operations (18)"
Cohesion: 0.50
...
### Community 1808 - "openspec/specs/structured-operations (55)"
Cohesion: 0.67
...
### Community 1090 - "openspec/specs/structured-operations (19)"
Cohesion: 0.50
...
### Community 1091 - "openspec/specs/structured-operations (20)"
Cohesion: 0.50
...
### Community 1093 - "openspec/specs/structured-operations (22)"
Cohesion: 0.50
...
### Community 742 - "openspec/specs/structured-operations (4)"
Cohesion: 0.40
...
### Community 1094 - "openspec/specs/structured-operations (23)"
Cohesion: 0.50
...
### Community 1810 - "openspec/specs/structured-operations (57)"
Cohesion: 0.67
...
### Community 1095 - "openspec/specs/structured-operations (24)"
Cohesion: 0.50
...
### Community 618 - "openspec/specs/structured-operations"
Cohesion: 0.33
...
### Community 1096 - "openspec/specs/structured-operations (25)"
Cohesion: 0.50
...
### Community 1097 - "openspec/specs/structured-operations (26)"
Cohesion: 0.50
...
### Community 1098 - "openspec/specs/structured-operations (27)"
Cohesion: 0.50
...
### Community 619 - "openspec/specs/structured-operations (2)"
Cohesion: 0.33
...
### Community 1099 - "openspec/specs/structured-operations (28)"
Cohesion: 0.50
...
### Community 1811 - "openspec/specs/structured-operations (58)"
Cohesion: 0.67
...
### Community 743 - "openspec/specs/structured-operations (5)"
Cohesion: 0.40
...
### Community 744 - "openspec/specs/structured-operations (6)"
Cohesion: 0.40
...
### Community 745 - "openspec/specs/structured-operations (7)"
Cohesion: 0.40
...
### Community 1100 - "openspec/specs/structured-operations (29)"
Cohesion: 0.50
...
### Community 1101 - "openspec/specs/structured-operations (30)"
Cohesion: 0.50
...
### Community 1812 - "openspec/specs/structured-operations (59)"
Cohesion: 0.67
...
### Community 746 - "openspec/specs/structured-operations (8)"
Cohesion: 0.40
...
### Community 1815 - "openspec/specs/structured-operations (62)"
Cohesion: 0.67
...
### Community 747 - "openspec/specs/structured-operations (9)"
Cohesion: 0.40
...
### Community 1816 - "openspec/specs/structured-operations (63)"
Cohesion: 0.67
...
### Community 1817 - "openspec/specs/structured-operations (64)"
Cohesion: 0.67
...
### Community 1107 - "openspec/specs/structured-operations (31)"
Cohesion: 0.50
...
### Community 1830 - "openspec/specs/structured-operations (65)"
Cohesion: 0.67
...
### Community 1108 - "openspec/specs/structured-operations (32)"
Cohesion: 0.50
...
### Community 1110 - "openspec/specs/structured-operations (34)"
Cohesion: 0.50
...
### Community 1111 - "openspec/specs/structured-operations (35)"
Cohesion: 0.50
...
### Community 1833 - "openspec/specs/structured-operations (68)"
Cohesion: 0.67
...
### Community 748 - "openspec/specs/structured-operations (10)"
Cohesion: 0.40
...
### Community 1835 - "openspec/specs/structured-operations (70)"
Cohesion: 0.67
...
### Community 1113 - "openspec/specs/structured-operations (37)"
Cohesion: 0.50
...
### Community 1114 - "openspec/specs/structured-operations (38)"
Cohesion: 0.50
...
### Community 1115 - "openspec/specs/structured-operations (39)"
Cohesion: 0.50
...
### Community 1836 - "openspec/specs/structured-operations (71)"
Cohesion: 0.67
...
### Community 1116 - "openspec/specs/structured-operations (40)"
Cohesion: 0.50
...
### Community 1117 - "openspec/specs/structured-operations (41)"
Cohesion: 0.50
...
### Community 1118 - "openspec/specs/structured-operations (42)"
Cohesion: 0.50
...
### Community 749 - "openspec/specs/structured-operations (11)"
Cohesion: 0.40
...
### Community 750 - "openspec/specs/structured-operations (12)"
Cohesion: 0.40
...
### Community 751 - "openspec/specs/structured-operations (13)"
Cohesion: 0.40
...
### Community 1119 - "openspec/specs/structured-operations (43)"
Cohesion: 0.50
...
### Community 1120 - "openspec/specs/structured-operations (44)"
Cohesion: 0.50
...
### Community 1837 - "openspec/specs/structured-operations (72)"
Cohesion: 0.67
...
### Community 752 - "openspec/specs/structured-operations (14)"
Cohesion: 0.40
...
### Community 1121 - "openspec/specs/structured-operations (45)"
Cohesion: 0.50
...
### Community 1122 - "openspec/specs/structured-operations (46)"
Cohesion: 0.50
...
### Community 1102 - "openspec/specs/structured-operations (47)"
Cohesion: 0.50
...
### Community 1818 - "openspec/specs/structured-operations (73)"
Cohesion: 0.67
...
### Community 1819 - "openspec/specs/structured-operations (74)"
Cohesion: 0.67
...
### Community 1821 - "openspec/specs/structured-operations (76)"
Cohesion: 0.67
...
### Community 1822 - "openspec/specs/structured-operations (77)"
Cohesion: 0.67
Nodes (3): Requirement: DB-286 — Tabela `resource_kinds`, Scenario: Unicidade no banco, Scenario: Origem dos registros

### Community 1104 - "openspec/specs/structured-operations (49)"
Cohesion: 0.50
...
### Community 1823 - "openspec/specs/structured-operations (78)"
Cohesion: 0.67
...
### Community 1824 - "openspec/specs/structured-operations (79)"
Cohesion: 0.67
...
### Community 1105 - "openspec/specs/structured-operations (50)"
Cohesion: 0.50
...
### Community 1106 - "openspec/specs/structured-operations (51)"
Cohesion: 0.50
...
### Community 1825 - "openspec/specs/structured-operations (80)"
Cohesion: 0.67
...
### Community 1828 - "openspec/specs/structured-operations (83)"
Cohesion: 0.67
...
### Community 1829 - "openspec/specs/structured-operations (84)"
Cohesion: 0.67
...
### Community 1123 - "openspec/specs/structured-operations (52)"
Cohesion: 0.50
...
### Community 1838 - "openspec/specs/structured-operations (85)"
Cohesion: 0.67
...
### Community 1839 - "openspec/specs/structured-operations (86)"
Cohesion: 0.67
...
### Community 1124 - "openspec/specs/structured-operations (53)"
Cohesion: 0.50
...
### Community 467 - "openspec/specs/themes - Requirements"
Cohesion: 0.22
...
### Community 1841 - "openspec/specs/themes (12)"
Cohesion: 0.67
...
### Community 753 - "openspec/specs/themes (2)"
Cohesion: 0.40
...
### Community 1125 - "openspec/specs/themes (4)"
Cohesion: 0.50
...
### Community 1126 - "openspec/specs/themes (5)"
Cohesion: 0.50
...
### Community 1842 - "openspec/specs/themes (13)"
Cohesion: 0.67
...
### Community 1843 - "openspec/specs/themes (14)"
Cohesion: 0.67
...
### Community 1845 - "openspec/specs/themes (16)"
Cohesion: 0.67
...
### Community 1128 - "openspec/specs/themes (7)"
Cohesion: 0.50
...
### Community 1847 - "openspec/specs/themes (18)"
Cohesion: 0.67
...
### Community 754 - "openspec/specs/themes (3)"
Cohesion: 0.40
...
### Community 620 - "openspec/specs/themes"
Cohesion: 0.33
...
### Community 1130 - "openspec/specs/themes (9)"
Cohesion: 0.50
...
### Community 1131 - "openspec/specs/themes (10)"
Cohesion: 0.50
...
### Community 1132 - "openspec/specs/themes (11)"
Cohesion: 0.50
...
### Community 583 - "Frontend Pages / pages - dictionaries.ts"
Cohesion: 0.33
Nodes (5): Chunk, NicheParams, RISCADO, REALCE, dictionaries

### Community 253 - "Frontend Components - useTheme"
Cohesion: 0.17
...
### Community 391 - "Frontend Components / charts - theme.ts"
Cohesion: 0.29
Nodes (7): RechartsBar(), RechartsLine(), getThemeVars(), SERIES, vibrantPalette(), LEAD_SOURCE_ORDER, leadSourceColor()

### Community 447 - "Frontend Components / chat - ChatCTA.tsx"
Cohesion: 0.28
Nodes (3): BaseCTAProps, TriggerAgentProps, SendIntentProps

### Community 495 - "Frontend Components / ui - drawer.tsx"
Cohesion: 0.25
Nodes (4): DrawerOverlay, DrawerContent, DrawerTitle, DrawerDescription

### Community 91 - ".migration-ai9/map - 2. Mapa item por item"
Cohesion: 0.07
...
### Community 187 - "ai9-base-catalog.md - Backend — o que existe"
Cohesion: 0.11
...
### Community 189 - ".migration-ai9/map (2)"
Cohesion: 0.11
...
### Community 65 - ".migration-ai9/map - 2. Tabela item por item"
Cohesion: 0.06
...
### Community 757 - "API Controllers / api - auth_response.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, AuthResponse

### Community 759 - "API Controllers / api - credential.rb"
Cohesion: 0.50
Nodes (3): Api, Entities, Credential

### Community 763 - "API Controllers / api - login_code_response.rb"
Cohesion: 0.50
...
### Community 569 - "API Controllers / api - defaults.rb"
Cohesion: 0.33
Nodes (3): Api, V1, Defaults

### Community 780 - "API Controllers / api - downloads.rb"
Cohesion: 0.67
Nodes (3): Api, V1, Downloads

### Community 519 - "Backend Services / ai - Condition"
Cohesion: 0.29
Nodes (3): Ai, Nodes, Condition

### Community 479 - "Backend Services / ai - Handoff"
Cohesion: 0.25
...
### Community 480 - "Backend Services / ai - Trigger"
Cohesion: 0.25
...
### Community 640 - "Frontend Components / chat - SequentialMessageBubble.tsx"
Cohesion: 0.40
Nodes (3): Block, ChatMessage, SequentialMessageBubbleProps

### Community 412 - "Frontend Features / chat-builder - nodes.ts"
Cohesion: 0.20
...
### Community 650 - "graphify-out/memory (2)"
Cohesion: 0.40
...
### Community 300 - "n8n_lma_refactor.md"
Cohesion: 0.14
...
### Community 364 - "specs_fix_plan.md"
Cohesion: 0.17
...
### Community 201 - "Backend Config / cable.yml - ActionCable Redis Adapter"
Cohesion: 0.12
...
### Community 825 - "README_TRACKING.md"
Cohesion: 0.50
...
### Community 348 - "docker-compose.yml"
Cohesion: 0.30
...
### Community 492 - "Frontend i18n / en - English i18n Catalogue"
Cohesion: 0.46
...
## Knowledge Gaps
- **7138 isolated node(s):** `BACKEND_WS`, `⚠ Por que `scripts/status.py` diz 127 abertos e não 63`, `O que provou os 67`, `Cinco defeitos, e quatro param a virada`, `Cinco achados, e dois desmentem artefato escrito` (+7133 more)
...
- **What is the exact relationship between `Lead Type Missing lead and instagram Properties` and `Rails API Endpoints Called by the Router (leads, operations/validate, executions, messages/bulk)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `respond()` connect `Backend Services / ai - agent_service.rb` to `Backend Services / ai - telemetry.rb`, `Backend Services / ai - conversation_memory.rb`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **What connects `BACKEND_WS`, `⚠ Por que `scripts/status.py` diz 127 abertos e não 63`, `O que provou os 67` to the rest of the system?**
  _7163 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Frontend Lib / api - console.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.06342780026990553 - nodes in this community are weakly interconnected._
- **Should `Frontend Pages / pages - ProfilePage.tsx` be split into smaller, more focused modules?**
